...
export function IoK8sApiAuthenticationV1alpha1SelfSubjectReviewFromJSON(
  json: any,
...
export function IoK8sApiAuthenticationV1alpha1SelfSubjectReviewFromJSONTyped(
  json: any,
  ...
  return {
    ...
    status: !exists(json, 'status')
      ? undefined
      : IoK8sApiAuthenticationV1alpha1SelfSubjectReviewStatusFromJSON(json['status']),
  };
}

export function IoK8sApiAuthenticationV1alpha1SelfSubjectReviewToJSON(
  value?: IoK8sApiAuthenticationV1alpha1SelfSubjectReview | null,
): any {
  if (value === undefined) {
    return undefined;
  }
