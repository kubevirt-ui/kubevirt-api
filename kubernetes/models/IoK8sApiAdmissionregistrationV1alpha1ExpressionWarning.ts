...
export function IoK8sApiAdmissionregistrationV1alpha1ExpressionWarningFromJSON(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1alpha1ExpressionWarningFromJSONTyped(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1alpha1ExpressionWarningToJSON(
  value?: IoK8sApiAdmissionregistrationV1alpha1ExpressionWarning | null,
): any {
  if (value === undefined) {
    return undefined;
  }
