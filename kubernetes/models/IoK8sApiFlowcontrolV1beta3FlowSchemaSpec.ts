...
export function IoK8sApiFlowcontrolV1beta3FlowSchemaSpecFromJSON(
  json: any,
): IoK8sApiFlowcontrolV1beta3FlowSchemaSpec {
  return IoK8sApiFlowcontrolV1beta3FlowSchemaSpecFromJSONTyped(json, false);
}

export function IoK8sApiFlowcontrolV1beta3FlowSchemaSpecFromJSONTyped(
  json: any,
  ...
  return {
    distinguisherMethod: !exists(json, 'distinguisherMethod')
      ? undefined
      : IoK8sApiFlowcontrolV1beta3FlowDistinguisherMethodFromJSON(json['distinguisherMethod']),
...
export function IoK8sApiFlowcontrolV1beta3FlowSchemaSpecToJSON(
  value?: IoK8sApiFlowcontrolV1beta3FlowSchemaSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    distinguisherMethod: IoK8sApiFlowcontrolV1beta3FlowDistinguisherMethodToJSON(
      value.distinguisherMethod,
    ),
    matchingPrecedence: value.matchingPrecedence,
    priorityLevelConfiguration: IoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationReferenceToJSON(
      value.priorityLevelConfiguration,
    ),
    rules:
      value.rules === undefined
        ? undefined
        : (value.rules as Array<any>).map(IoK8sApiFlowcontrolV1beta3PolicyRulesWithSubjectsToJSON),
  };
}
