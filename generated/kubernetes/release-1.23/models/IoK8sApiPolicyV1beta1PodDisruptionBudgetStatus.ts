...
export function IoK8sApiPolicyV1beta1PodDisruptionBudgetStatusFromJSON(json: any): IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus {
    return IoK8sApiPolicyV1beta1PodDisruptionBudgetStatusFromJSONTyped(json, false);
}

export function IoK8sApiPolicyV1beta1PodDisruptionBudgetStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus {
...
export function IoK8sApiPolicyV1beta1PodDisruptionBudgetStatusToJSON(value?: IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
