...
import {
    ...
    V1alpha1VirtualMachineClusterFlavorListToJSON,
    ...
    V1alpha1VirtualMachineClusterPreferenceListToJSON,
    ...
    V1alpha1VirtualMachineExportListToJSON,
    ...
    V1alpha1VirtualMachineFlavorListToJSON,
    ...
    V1alpha1VirtualMachinePreferenceListToJSON,
    ...
    V1alpha1VirtualMachineRestoreListToJSON,
    ...
    V1alpha1VirtualMachineSnapshotContentListToJSON,
    V1alpha1VirtualMachineSnapshotList,
    V1alpha1VirtualMachineSnapshotListFromJSON,
    V1alpha1VirtualMachineSnapshotListToJSON,
} from '../models';
...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async createNamespacedKubeVirtRaw(requestParameters: CreateNamespacedKubeVirtRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1KubeVirt>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/kubevirt`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async createNamespacedVirtualMachineRaw(requestParameters: CreateNamespacedVirtualMachineRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachine>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     */
    async createNamespacedVirtualMachineExportRaw(requestParameters: CreateNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineExport>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        const response = await this.request({
            path: `/apis/export.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineexports`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineExportFromJSON(jsonValue));
    }

    /**
     * Create a VirtualMachineExport object.
     */
    async createNamespacedVirtualMachineExport(requestParameters: CreateNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineExport> {
     ...
     */
    async createNamespacedVirtualMachineFlavorRaw(requestParameters: CreateNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineFlavor>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling createNamespacedVirtualMachineFlavor.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling createNamespacedVirtualMachineFlavor.');
        }
        ...
        const response = await this.request({
            path: `/apis/flavor.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineflavors`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineFlavorFromJSON(jsonValue));
    }

    /**
     * Create a VirtualMachineFlavor object.
     */
    async createNamespacedVirtualMachineFlavor(requestParameters: CreateNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineFlavor> {
        const response = await this.createNamespacedVirtualMachineFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async createNamespacedVirtualMachineInstanceRaw(requestParameters: CreateNamespacedVirtualMachineInstanceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstance>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async createNamespacedVirtualMachineInstanceMigrationRaw(requestParameters: CreateNamespacedVirtualMachineInstanceMigrationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstanceMigration>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancemigrations`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async createNamespacedVirtualMachineInstancePresetRaw(requestParameters: CreateNamespacedVirtualMachineInstancePresetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstancePreset>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancepresets`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async createNamespacedVirtualMachineInstanceReplicaSetRaw(requestParameters: CreateNamespacedVirtualMachineInstanceReplicaSetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstanceReplicaSet>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancereplicasets`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async createNamespacedVirtualMachinePoolRaw(requestParameters: CreateNamespacedVirtualMachinePoolRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachinePool>> {
        ...
        const response = await this.request({
            path: `/apis/pool.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinepools`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     */
    async createNamespacedVirtualMachinePreferenceRaw(requestParameters: CreateNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachinePreference>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        const response = await this.request({
            path: `/apis/flavor.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinepreferences`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachinePreferenceFromJSON(jsonValue));
    }

    /**
     * Create a VirtualMachinePreference object.
     */
    async createNamespacedVirtualMachinePreference(requestParameters: CreateNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachinePreference> {
     ...
     */
    async createNamespacedVirtualMachineRestoreRaw(requestParameters: CreateNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineRestore>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineRestoreFromJSON(jsonValue));
    }

    /**
     * Create a VirtualMachineRestore object.
     */
    async createNamespacedVirtualMachineRestore(requestParameters: CreateNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineRestore> {
     ...
     */
    async createNamespacedVirtualMachineSnapshotRaw(requestParameters: CreateNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshot>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinesnapshots`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineSnapshotFromJSON(jsonValue));
    }

    /**
     * Create a VirtualMachineSnapshot object.
     */
    async createNamespacedVirtualMachineSnapshot(requestParameters: CreateNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshot> {
     ...
     */
    async createNamespacedVirtualMachineSnapshotContentRaw(requestParameters: CreateNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshotContent>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinesnapshotcontents`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineSnapshotContentFromJSON(jsonValue));
    }

    /**
     * Create a VirtualMachineSnapshotContent object.
     */
    async createNamespacedVirtualMachineSnapshotContent(requestParameters: CreateNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshotContent> {
     ...
     */
    async createVirtualMachineClusterFlavorRaw(requestParameters: CreateVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterFlavor>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling createVirtualMachineClusterFlavor.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineClusterFlavorFromJSON(jsonValue));
    }

    /**
     * Create a VirtualMachineClusterFlavor object.
     */
    async createVirtualMachineClusterFlavor(requestParameters: CreateVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterFlavor> {
        const response = await this.createVirtualMachineClusterFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async createVirtualMachineClusterPreferenceRaw(requestParameters: CreateVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterPreference>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineClusterPreferenceFromJSON(jsonValue));
    }

    /**
     * Create a VirtualMachineClusterPreference object.
     */
    async createVirtualMachineClusterPreference(requestParameters: CreateVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterPreference> {
     ...
     */
    async deleteCollectionNamespacedVirtualMachineFlavorRaw(requestParameters: DeleteCollectionNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        const queryParameters: any = {};
     ...
     * Delete a collection of VirtualMachineFlavor objects.
     */
    async deleteCollectionNamespacedVirtualMachineFlavor(requestParameters: DeleteCollectionNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1Status> {
        const response = await this.deleteCollectionNamespacedVirtualMachineFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteCollectionVirtualMachineClusterFlavorRaw(requestParameters: DeleteCollectionVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        const queryParameters: any = {};
     ...
     * Delete a collection of VirtualMachineClusterFlavor objects.
     */
    async deleteCollectionVirtualMachineClusterFlavor(requestParameters: DeleteCollectionVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1Status> {
        const response = await this.deleteCollectionVirtualMachineClusterFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async deleteMigrationPolicyRaw(requestParameters: DeleteMigrationPolicyRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/migrations.kubevirt.io/v1alpha1/migrationpolicies/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
    ...
    async deleteNamespacedKubeVirtRaw(requestParameters: DeleteNamespacedKubeVirtRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/kubevirt/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachineRaw(requestParameters: DeleteNamespacedVirtualMachineRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachineExportRaw(requestParameters: DeleteNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/export.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineexports/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
     ...
     */
    async deleteNamespacedVirtualMachineFlavorRaw(requestParameters: DeleteNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling deleteNamespacedVirtualMachineFlavor.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling deleteNamespacedVirtualMachineFlavor.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling deleteNamespacedVirtualMachineFlavor.');
        }
        ...
        const response = await this.request({
            path: `/apis/flavor.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineflavors/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
     ...
     * Delete a VirtualMachineFlavor object.
     */
    async deleteNamespacedVirtualMachineFlavor(requestParameters: DeleteNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1Status> {
        const response = await this.deleteNamespacedVirtualMachineFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async deleteNamespacedVirtualMachineInstanceRaw(requestParameters: DeleteNamespacedVirtualMachineInstanceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachineInstanceMigrationRaw(requestParameters: DeleteNamespacedVirtualMachineInstanceMigrationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancemigrations/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachineInstancePresetRaw(requestParameters: DeleteNamespacedVirtualMachineInstancePresetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancepresets/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachineInstanceReplicaSetRaw(requestParameters: DeleteNamespacedVirtualMachineInstanceReplicaSetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancereplicasets/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachinePoolRaw(requestParameters: DeleteNamespacedVirtualMachinePoolRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/pool.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinepools/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachinePreferenceRaw(requestParameters: DeleteNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/flavor.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinepreferences/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachineRestoreRaw(requestParameters: DeleteNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachineSnapshotRaw(requestParameters: DeleteNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinesnapshots/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteNamespacedVirtualMachineSnapshotContentRaw(requestParameters: DeleteNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinesnapshotcontents/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
    ...
    async deleteVirtualMachineCloneRaw(requestParameters: DeleteVirtualMachineCloneRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/clone.kubevirt.io/v1alpha1/virtualmachineclones/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
     ...
     */
    async deleteVirtualMachineClusterFlavorRaw(requestParameters: DeleteVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling deleteVirtualMachineClusterFlavor.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling deleteVirtualMachineClusterFlavor.');
        }
        ...
        const response = await this.request({
            path: `/apis/flavor.kubevirt.io/v1alpha1/virtualmachineclusterflavors/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
     ...
     * Delete a VirtualMachineClusterFlavor object.
     */
    async deleteVirtualMachineClusterFlavor(requestParameters: DeleteVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1Status> {
        const response = await this.deleteVirtualMachineClusterFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async deleteVirtualMachineClusterPreferenceRaw(requestParameters: DeleteVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1Status>> {
        ...
        const response = await this.request({
            path: `/apis/flavor.kubevirt.io/v1alpha1/virtualmachineclusterpreferences/{name:[a-z0-9][a-z0-9\-]*}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: K8sIoApimachineryPkgApisMetaV1DeleteOptionsToJSON(requestParameters.body),
     ...
     * Get a KubeVirt API group
     */
    async getAPIGroupFlavorKubevirtIoRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1APIGroup>> {
        const queryParameters: any = {};
     ...
     * Get a KubeVirt API group
     */
    async getAPIGroupFlavorKubevirtIo(initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1APIGroup> {
     ...
     * Get KubeVirt API Resources
     */
    async getAPIResourcesExportKubevirtIoV1alpha1Raw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1APIResourceList>> {
        const queryParameters: any = {};
     ...
     * Get KubeVirt API Resources
     */
    async getAPIResourcesExportKubevirtIoV1alpha1(initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1APIResourceList> {
     ...
     * Get KubeVirt API Resources
     */
    async getAPIResourcesFlavorKubevirtIoV1alpha1Raw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1APIResourceList>> {
        const queryParameters: any = {};
     ...
     * Get KubeVirt API Resources
     */
    async getAPIResourcesFlavorKubevirtIoV1alpha1(initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1APIResourceList> {
     ...
     * Get KubeVirt API Resources
     */
    async getAPIResourcesSnapshotKubevirtIoV1alpha1Raw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1APIResourceList>> {
        const queryParameters: any = {};
     ...
     * Get KubeVirt API Resources
     */
    async getAPIResourcesSnapshotKubevirtIoV1alpha1(initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1APIResourceList> {
     ...
     */
    async listNamespacedVirtualMachineExportRaw(requestParameters: ListNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineExportList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineExportListFromJSON(jsonValue));
    }

    /**
     * Get a list of VirtualMachineExport objects.
     */
    async listNamespacedVirtualMachineExport(requestParameters: ListNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineExportList> {
     ...
     */
    async listNamespacedVirtualMachineFlavorRaw(requestParameters: ListNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineFlavorList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling listNamespacedVirtualMachineFlavor.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineFlavorListFromJSON(jsonValue));
    }

    /**
     * Get a list of VirtualMachineFlavor objects.
     */
    async listNamespacedVirtualMachineFlavor(requestParameters: ListNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineFlavorList> {
        const response = await this.listNamespacedVirtualMachineFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listNamespacedVirtualMachinePreferenceRaw(requestParameters: ListNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachinePreferenceList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachinePreferenceListFromJSON(jsonValue));
    }

    /**
     * Get a list of VirtualMachinePreference objects.
     */
    async listNamespacedVirtualMachinePreference(requestParameters: ListNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachinePreferenceList> {
     ...
     */
    async listNamespacedVirtualMachineRestoreRaw(requestParameters: ListNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineRestoreList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineRestoreListFromJSON(jsonValue));
    }

    /**
     * Get a list of VirtualMachineRestore objects.
     */
    async listNamespacedVirtualMachineRestore(requestParameters: ListNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineRestoreList> {
     ...
     */
    async listNamespacedVirtualMachineSnapshotRaw(requestParameters: ListNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshotList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineSnapshotListFromJSON(jsonValue));
    }

    /**
     * Get a list of VirtualMachineSnapshot objects.
     */
    async listNamespacedVirtualMachineSnapshot(requestParameters: ListNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshotList> {
     ...
     */
    async listNamespacedVirtualMachineSnapshotContentRaw(requestParameters: ListNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshotContentList>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineSnapshotContentListFromJSON(jsonValue));
    }

    /**
     * Get a list of VirtualMachineSnapshotContent objects.
     */
    async listNamespacedVirtualMachineSnapshotContent(requestParameters: ListNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshotContentList> {
     ...
     */
    async listVirtualMachineClusterFlavorRaw(requestParameters: ListVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterFlavorList>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineClusterFlavorListFromJSON(jsonValue));
    }

    /**
     * Get a list of VirtualMachineClusterFlavor objects.
     */
    async listVirtualMachineClusterFlavor(requestParameters: ListVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterFlavorList> {
        const response = await this.listVirtualMachineClusterFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listVirtualMachineClusterPreferenceRaw(requestParameters: ListVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterPreferenceList>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1alpha1VirtualMachineClusterPreferenceListFromJSON(jsonValue));
    }

    /**
     * Get a list of VirtualMachineClusterPreference objects.
     */
    async listVirtualMachineClusterPreference(requestParameters: ListVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterPreferenceList> {
     ...
     */
    async listVirtualMachineExportForAllNamespacesRaw(requestParameters: ListVirtualMachineExportForAllNamespacesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineExportList>> {
        const queryParameters: any = {};
     ...
     * Get a list of all VirtualMachineExport objects.
     */
    async listVirtualMachineExportForAllNamespaces(requestParameters: ListVirtualMachineExportForAllNamespacesRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineExportList> {
     ...
     */
    async listVirtualMachineFlavorForAllNamespacesRaw(requestParameters: ListVirtualMachineFlavorForAllNamespacesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineFlavorList>> {
        const queryParameters: any = {};
     ...
     * Get a list of all VirtualMachineFlavor objects.
     */
    async listVirtualMachineFlavorForAllNamespaces(requestParameters: ListVirtualMachineFlavorForAllNamespacesRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineFlavorList> {
        const response = await this.listVirtualMachineFlavorForAllNamespacesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listVirtualMachinePreferenceForAllNamespacesRaw(requestParameters: ListVirtualMachinePreferenceForAllNamespacesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachinePreferenceList>> {
        const queryParameters: any = {};
     ...
     * Get a list of all VirtualMachinePreference objects.
     */
    async listVirtualMachinePreferenceForAllNamespaces(requestParameters: ListVirtualMachinePreferenceForAllNamespacesRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachinePreferenceList> {
     ...
     */
    async listVirtualMachineRestoreForAllNamespacesRaw(requestParameters: ListVirtualMachineRestoreForAllNamespacesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineRestoreList>> {
        const queryParameters: any = {};
     ...
     * Get a list of all VirtualMachineRestore objects.
     */
    async listVirtualMachineRestoreForAllNamespaces(requestParameters: ListVirtualMachineRestoreForAllNamespacesRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineRestoreList> {
     ...
     */
    async listVirtualMachineSnapshotContentForAllNamespacesRaw(requestParameters: ListVirtualMachineSnapshotContentForAllNamespacesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshotContentList>> {
        const queryParameters: any = {};
     ...
     * Get a list of all VirtualMachineSnapshotContent objects.
     */
    async listVirtualMachineSnapshotContentForAllNamespaces(requestParameters: ListVirtualMachineSnapshotContentForAllNamespacesRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshotContentList> {
     ...
     */
    async listVirtualMachineSnapshotForAllNamespacesRaw(requestParameters: ListVirtualMachineSnapshotForAllNamespacesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshotList>> {
        const queryParameters: any = {};
     ...
     * Get a list of all VirtualMachineSnapshot objects.
     */
    async listVirtualMachineSnapshotForAllNamespaces(requestParameters: ListVirtualMachineSnapshotForAllNamespacesRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshotList> {
     ...
     */
    async patchNamespacedVirtualMachineExportRaw(requestParameters: PatchNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineExport>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Patch a VirtualMachineExport object.
     */
    async patchNamespacedVirtualMachineExport(requestParameters: PatchNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineExport> {
     ...
     */
    async patchNamespacedVirtualMachineFlavorRaw(requestParameters: PatchNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineFlavor>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling patchNamespacedVirtualMachineFlavor.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling patchNamespacedVirtualMachineFlavor.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling patchNamespacedVirtualMachineFlavor.');
        }
     ...
     * Patch a VirtualMachineFlavor object.
     */
    async patchNamespacedVirtualMachineFlavor(requestParameters: PatchNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineFlavor> {
        const response = await this.patchNamespacedVirtualMachineFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async patchNamespacedVirtualMachinePreferenceRaw(requestParameters: PatchNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachinePreference>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Patch a VirtualMachinePreference object.
     */
    async patchNamespacedVirtualMachinePreference(requestParameters: PatchNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachinePreference> {
     ...
     */
    async patchNamespacedVirtualMachineRestoreRaw(requestParameters: PatchNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineRestore>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Patch a VirtualMachineRestore object.
     */
    async patchNamespacedVirtualMachineRestore(requestParameters: PatchNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineRestore> {
     ...
     */
    async patchNamespacedVirtualMachineSnapshotRaw(requestParameters: PatchNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshot>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Patch a VirtualMachineSnapshot object.
     */
    async patchNamespacedVirtualMachineSnapshot(requestParameters: PatchNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshot> {
     ...
     */
    async patchNamespacedVirtualMachineSnapshotContentRaw(requestParameters: PatchNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshotContent>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Patch a VirtualMachineSnapshotContent object.
     */
    async patchNamespacedVirtualMachineSnapshotContent(requestParameters: PatchNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshotContent> {
     ...
     */
    async patchVirtualMachineClusterFlavorRaw(requestParameters: PatchVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterFlavor>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling patchVirtualMachineClusterFlavor.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling patchVirtualMachineClusterFlavor.');
        }
     ...
     * Patch a VirtualMachineClusterFlavor object.
     */
    async patchVirtualMachineClusterFlavor(requestParameters: PatchVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterFlavor> {
        const response = await this.patchVirtualMachineClusterFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async patchVirtualMachineClusterPreferenceRaw(requestParameters: PatchVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterPreference>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Patch a VirtualMachineClusterPreference object.
     */
    async patchVirtualMachineClusterPreference(requestParameters: PatchVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterPreference> {
     ...
     */
    async readNamespacedVirtualMachineExportRaw(requestParameters: ReadNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineExport>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Get a VirtualMachineExport object.
     */
    async readNamespacedVirtualMachineExport(requestParameters: ReadNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineExport> {
     ...
     */
    async readNamespacedVirtualMachineFlavorRaw(requestParameters: ReadNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineFlavor>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling readNamespacedVirtualMachineFlavor.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling readNamespacedVirtualMachineFlavor.');
        }
     ...
     * Get a VirtualMachineFlavor object.
     */
    async readNamespacedVirtualMachineFlavor(requestParameters: ReadNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineFlavor> {
        const response = await this.readNamespacedVirtualMachineFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async readNamespacedVirtualMachinePreferenceRaw(requestParameters: ReadNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachinePreference>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Get a VirtualMachinePreference object.
     */
    async readNamespacedVirtualMachinePreference(requestParameters: ReadNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachinePreference> {
     ...
     */
    async readNamespacedVirtualMachineRestoreRaw(requestParameters: ReadNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineRestore>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Get a VirtualMachineRestore object.
     */
    async readNamespacedVirtualMachineRestore(requestParameters: ReadNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineRestore> {
     ...
     */
    async readNamespacedVirtualMachineSnapshotRaw(requestParameters: ReadNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshot>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Get a VirtualMachineSnapshot object.
     */
    async readNamespacedVirtualMachineSnapshot(requestParameters: ReadNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshot> {
     ...
     */
    async readNamespacedVirtualMachineSnapshotContentRaw(requestParameters: ReadNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshotContent>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Get a VirtualMachineSnapshotContent object.
     */
    async readNamespacedVirtualMachineSnapshotContent(requestParameters: ReadNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshotContent> {
     ...
     */
    async readVirtualMachineClusterFlavorRaw(requestParameters: ReadVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterFlavor>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling readVirtualMachineClusterFlavor.');
        }
     ...
     * Get a VirtualMachineClusterFlavor object.
     */
    async readVirtualMachineClusterFlavor(requestParameters: ReadVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterFlavor> {
        const response = await this.readVirtualMachineClusterFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async readVirtualMachineClusterPreferenceRaw(requestParameters: ReadVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterPreference>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Get a VirtualMachineClusterPreference object.
     */
    async readVirtualMachineClusterPreference(requestParameters: ReadVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterPreference> {
     ...
     */
    async replaceNamespacedVirtualMachineExportRaw(requestParameters: ReplaceNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineExport>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Update a VirtualMachineExport object.
     */
    async replaceNamespacedVirtualMachineExport(requestParameters: ReplaceNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineExport> {
     ...
     */
    async replaceNamespacedVirtualMachineFlavorRaw(requestParameters: ReplaceNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineFlavor>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling replaceNamespacedVirtualMachineFlavor.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling replaceNamespacedVirtualMachineFlavor.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling replaceNamespacedVirtualMachineFlavor.');
        }
     ...
     * Update a VirtualMachineFlavor object.
     */
    async replaceNamespacedVirtualMachineFlavor(requestParameters: ReplaceNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineFlavor> {
        const response = await this.replaceNamespacedVirtualMachineFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async replaceNamespacedVirtualMachinePreferenceRaw(requestParameters: ReplaceNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachinePreference>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Update a VirtualMachinePreference object.
     */
    async replaceNamespacedVirtualMachinePreference(requestParameters: ReplaceNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachinePreference> {
     ...
     */
    async replaceNamespacedVirtualMachineRestoreRaw(requestParameters: ReplaceNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineRestore>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Update a VirtualMachineRestore object.
     */
    async replaceNamespacedVirtualMachineRestore(requestParameters: ReplaceNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineRestore> {
     ...
     */
    async replaceNamespacedVirtualMachineSnapshotRaw(requestParameters: ReplaceNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshot>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Update a VirtualMachineSnapshot object.
     */
    async replaceNamespacedVirtualMachineSnapshot(requestParameters: ReplaceNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshot> {
     ...
     */
    async replaceNamespacedVirtualMachineSnapshotContentRaw(requestParameters: ReplaceNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineSnapshotContent>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Update a VirtualMachineSnapshotContent object.
     */
    async replaceNamespacedVirtualMachineSnapshotContent(requestParameters: ReplaceNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineSnapshotContent> {
     ...
     */
    async replaceVirtualMachineClusterFlavorRaw(requestParameters: ReplaceVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterFlavor>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling replaceVirtualMachineClusterFlavor.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling replaceVirtualMachineClusterFlavor.');
        }
     ...
     * Update a VirtualMachineClusterFlavor object.
     */
    async replaceVirtualMachineClusterFlavor(requestParameters: ReplaceVirtualMachineClusterFlavorRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterFlavor> {
        const response = await this.replaceVirtualMachineClusterFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async replaceVirtualMachineClusterPreferenceRaw(requestParameters: ReplaceVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1alpha1VirtualMachineClusterPreference>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * Update a VirtualMachineClusterPreference object.
     */
    async replaceVirtualMachineClusterPreference(requestParameters: ReplaceVirtualMachineClusterPreferenceRequest, initOverrides?: RequestInit): Promise<V1alpha1VirtualMachineClusterPreference> {
    ...
    async v1ConsoleRaw(requestParameters: V1ConsoleRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/console`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     */
    async v1FilesystemlistRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstanceFileSystemList>> {
        const queryParameters: any = {};
     ...
     * Get list of active filesystems on guest machine via guest agent
     */
    async v1Filesystemlist(initOverrides?: RequestInit): Promise<V1VirtualMachineInstanceFileSystemList> {
    ...
    async v1FreezeRaw(requestParameters: V1FreezeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/freeze`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
    ...
    async v1GuestosinfoRaw(requestParameters: V1GuestosinfoRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstanceGuestAgentInfo>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/guestosinfo`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1MemoryDumpRaw(requestParameters: V1MemoryDumpRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/memorydump`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
    ...
    async v1MigrateRaw(requestParameters: V1MigrateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/migrate`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
    ...
    async v1PauseRaw(requestParameters: V1PauseRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/pause`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
    ...
    async v1RemoveMemoryDumpRaw(requestParameters: V1RemoveMemoryDumpRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/removememorydump`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1RestartRaw(requestParameters: V1RestartRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/restart`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
    ...
    async v1SoftRebootRaw(requestParameters: V1SoftRebootRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/softreboot`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1StartRaw(requestParameters: V1StartRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/start`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
    ...
    async v1StopRaw(requestParameters: V1StopRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/stop`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
     ...
     */
    async v1TestRaw(requestParameters: V1TestRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling v1Test.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling v1Test.');
        }
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/test`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1UnfreezeRaw(requestParameters: V1UnfreezeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/unfreeze`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1UnpauseRaw(requestParameters: V1UnpauseRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/unpause`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
     ...
     */
    async v1UserlistRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstanceGuestOSUserList>> {
        const queryParameters: any = {};
    ...
    async v1VNCRaw(requestParameters: V1VNCRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/vnc`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3ConsoleRaw(requestParameters: V1alpha3ConsoleRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/console`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get list of active filesystems on guest machine via guest agent
     */
    async v1alpha3FilesystemlistRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstanceFileSystemList>> {
        const queryParameters: any = {};
     ...
     * Get list of active filesystems on guest machine via guest agent
     */
    async v1alpha3Filesystemlist(initOverrides?: RequestInit): Promise<V1VirtualMachineInstanceFileSystemList> {
    ...
    async v1alpha3FreezeRaw(requestParameters: V1alpha3FreezeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/freeze`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1FreezeUnfreezeTimeoutToJSON(requestParameters.body),
     ...
     * Get a KubeVirt API Group
     */
    async v1alpha3GetSubAPIGroupRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1APIGroup>> {
        const queryParameters: any = {};
     ...
     * Get a KubeVirt API Group
     */
    async v1alpha3GetSubAPIGroup(initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1APIGroup> {
    ...
    async v1alpha3GuestosinfoRaw(requestParameters: V1alpha3GuestosinfoRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstanceGuestAgentInfo>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/guestosinfo`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3MemoryDumpRaw(requestParameters: V1alpha3MemoryDumpRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/memorydump`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1VirtualMachineMemoryDumpRequestToJSON(requestParameters.body),
    ...
    async v1alpha3MigrateRaw(requestParameters: V1alpha3MigrateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/migrate`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1MigrateOptionsToJSON(requestParameters.body),
    ...
    async v1alpha3PauseRaw(requestParameters: V1alpha3PauseRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/pause`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1PauseOptionsToJSON(requestParameters.body),
    ...
    async v1alpha3RemoveMemoryDumpRaw(requestParameters: V1alpha3RemoveMemoryDumpRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/removememorydump`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3RestartRaw(requestParameters: V1alpha3RestartRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/restart`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1RestartOptionsToJSON(requestParameters.body),
    ...
    async v1alpha3SoftRebootRaw(requestParameters: V1alpha3SoftRebootRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/softreboot`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3StartRaw(requestParameters: V1alpha3StartRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/start`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1StartOptionsToJSON(requestParameters.body),
    ...
    async v1alpha3StopRaw(requestParameters: V1alpha3StopRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/stop`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1StopOptionsToJSON(requestParameters.body),
     ...
     * Test endpoint verifying apiserver connectivity.
     */
    async v1alpha3TestRaw(requestParameters: V1alpha3TestRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling v1alpha3Test.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling v1alpha3Test.');
        }
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/test`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Test endpoint verifying apiserver connectivity.
     */
    async v1alpha3Test(requestParameters: V1alpha3TestRequest, initOverrides?: RequestInit): Promise<void> {
    ...
    async v1alpha3UnfreezeRaw(requestParameters: V1alpha3UnfreezeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/unfreeze`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3UnpauseRaw(requestParameters: V1alpha3UnpauseRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/unpause`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1UnpauseOptionsToJSON(requestParameters.body),
     ...
     * Get list of active users via guest agent
     */
    async v1alpha3UserlistRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1VirtualMachineInstanceGuestOSUserList>> {
        const queryParameters: any = {};
     ...
     * Get list of active users via guest agent
     */
    async v1alpha3Userlist(initOverrides?: RequestInit): Promise<V1VirtualMachineInstanceGuestOSUserList> {
    ...
    async v1alpha3VNCRaw(requestParameters: V1alpha3VNCRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/vnc`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3usbredirRaw(requestParameters: V1alpha3usbredirRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/usbredir`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3vmAddvolumeRaw(requestParameters: V1alpha3vmAddvolumeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/addvolume`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
    ...
    async v1alpha3vmPortForwardWithProtocolRaw(requestParameters: V1alpha3vmPortForwardWithProtocolRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/portforward/{port:[0-9]+}/{protocol:tcp|udp}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))).replace(`{${"port"}}`, encodeURIComponent(String(requestParameters.port))).replace(`{${"protocol"}}`, encodeURIComponent(String(requestParameters.protocol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3vmRemovevolumeRaw(requestParameters: V1alpha3vmRemovevolumeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/removevolume`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
    ...
    async v1alpha3vmiAddvolumeRaw(requestParameters: V1alpha3vmiAddvolumeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/addvolume`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1AddVolumeOptionsToJSON(requestParameters.body),
    ...
    async v1alpha3vmiPortForwardRaw(requestParameters: V1alpha3vmiPortForwardRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/portforward/{port:[0-9]+}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))).replace(`{${"port"}}`, encodeURIComponent(String(requestParameters.port))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3vmiPortForwardWithProtocolRaw(requestParameters: V1alpha3vmiPortForwardWithProtocolRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/portforward/{port:[0-9]+}/{protocol:tcp|udp}`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))).replace(`{${"port"}}`, encodeURIComponent(String(requestParameters.port))).replace(`{${"protocol"}}`, encodeURIComponent(String(requestParameters.protocol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1alpha3vmiRemovevolumeRaw(requestParameters: V1alpha3vmiRemovevolumeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/removevolume`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1RemoveVolumeOptionsToJSON(requestParameters.body),
    ...
    async v1usbredirRaw(requestParameters: V1usbredirRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/usbredir`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async v1vmAddvolumeRaw(requestParameters: V1vmAddvolumeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/addvolume`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1AddVolumeOptionsToJSON(requestParameters.body),
    ...
    async v1vmRemovevolumeRaw(requestParameters: V1vmRemovevolumeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/removevolume`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1RemoveVolumeOptionsToJSON(requestParameters.body),
    ...
    async v1vmiAddvolumeRaw(requestParameters: V1vmiAddvolumeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/addvolume`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1AddVolumeOptionsToJSON(requestParameters.body),
    ...
    async v1vmiRemovevolumeRaw(requestParameters: V1vmiRemovevolumeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/removevolume`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1RemoveVolumeOptionsToJSON(requestParameters.body),
    ...
    async watchNamespacedKubeVirtRaw(requestParameters: WatchNamespacedKubeVirtRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/kubevirt`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachineRaw(requestParameters: WatchNamespacedVirtualMachineRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachineExportRaw(requestParameters: WatchNamespacedVirtualMachineExportRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/export.kubevirt.io/v1alpha1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineexports`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     */
    async watchNamespacedVirtualMachineFlavorRaw(requestParameters: WatchNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling watchNamespacedVirtualMachineFlavor.');
        }
        ...
        const response = await this.request({
            path: `/apis/flavor.kubevirt.io/v1alpha1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineflavors`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Watch a VirtualMachineFlavor object.
     */
    async watchNamespacedVirtualMachineFlavor(requestParameters: WatchNamespacedVirtualMachineFlavorRequest, initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1WatchEvent> {
        const response = await this.watchNamespacedVirtualMachineFlavorRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async watchNamespacedVirtualMachineInstanceRaw(requestParameters: WatchNamespacedVirtualMachineInstanceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachineInstanceMigrationRaw(requestParameters: WatchNamespacedVirtualMachineInstanceMigrationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancemigrations`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachineInstancePresetRaw(requestParameters: WatchNamespacedVirtualMachineInstancePresetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancepresets`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachineInstanceReplicaSetRaw(requestParameters: WatchNamespacedVirtualMachineInstanceReplicaSetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/kubevirt.io/v1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstancereplicasets`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachinePoolRaw(requestParameters: WatchNamespacedVirtualMachinePoolRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/pool.kubevirt.io/v1alpha1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinepools`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachinePreferenceRaw(requestParameters: WatchNamespacedVirtualMachinePreferenceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/flavor.kubevirt.io/v1alpha1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinepreferences`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachineRestoreRaw(requestParameters: WatchNamespacedVirtualMachineRestoreRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinerestores`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachineSnapshotRaw(requestParameters: WatchNamespacedVirtualMachineSnapshotRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinesnapshots`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async watchNamespacedVirtualMachineSnapshotContentRaw(requestParameters: WatchNamespacedVirtualMachineSnapshotContentRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        ...
        const response = await this.request({
            path: `/apis/snapshot.kubevirt.io/v1alpha1/watch/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachinesnapshotcontents`.replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     */
    async watchVirtualMachineClusterFlavorListForAllNamespacesRaw(requestParameters: WatchVirtualMachineClusterFlavorListForAllNamespacesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        const queryParameters: any = {};
     ...
     * Watch a VirtualMachineClusterFlavorList object.
     */
    async watchVirtualMachineClusterFlavorListForAllNamespaces(requestParameters: WatchVirtualMachineClusterFlavorListForAllNamespacesRequest, initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1WatchEvent> {
        const response = await this.watchVirtualMachineClusterFlavorListForAllNamespacesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async watchVirtualMachineFlavorListForAllNamespacesRaw(requestParameters: WatchVirtualMachineFlavorListForAllNamespacesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<K8sIoApimachineryPkgApisMetaV1WatchEvent>> {
        const queryParameters: any = {};
     ...
     * Watch a VirtualMachineFlavorList object.
     */
    async watchVirtualMachineFlavorListForAllNamespaces(requestParameters: WatchVirtualMachineFlavorListForAllNamespacesRequest, initOverrides?: RequestInit): Promise<K8sIoApimachineryPkgApisMetaV1WatchEvent> {
        const response = await this.watchVirtualMachineFlavorListForAllNamespacesRaw(requestParameters, initOverrides);
        return await response.value();
    }
