...
export class FlowcontrolApiserverApi extends runtime.BaseAPI {
     ...
     */
    async getFlowcontrolApiserverAPIGroupRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getFlowcontrolApiserverAPIGroup(initOverrides?: RequestInit): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
