...
export function IoK8sApiAuthorizationV1SubjectAccessReviewFromJSON(
  json: any,
): IoK8sApiAuthorizationV1SubjectAccessReview {
  return IoK8sApiAuthorizationV1SubjectAccessReviewFromJSONTyped(json, false);
}

export function IoK8sApiAuthorizationV1SubjectAccessReviewFromJSONTyped(
  json: any,
...
export function IoK8sApiAuthorizationV1SubjectAccessReviewToJSON(
  value?: IoK8sApiAuthorizationV1SubjectAccessReview | null,
): any {
  if (value === undefined) {
    return undefined;
  }
