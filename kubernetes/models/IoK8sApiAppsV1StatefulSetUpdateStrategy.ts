...
export function IoK8sApiAppsV1StatefulSetUpdateStrategyFromJSONTyped(
  json: any,
...
export function IoK8sApiAppsV1StatefulSetUpdateStrategyToJSON(
  value?: IoK8sApiAppsV1StatefulSetUpdateStrategy | null,
): any {
  if (value === undefined) {
    return undefined;
  }
