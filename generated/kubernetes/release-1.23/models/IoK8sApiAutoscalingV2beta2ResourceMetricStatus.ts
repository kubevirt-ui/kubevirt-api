...
export function IoK8sApiAutoscalingV2beta2ResourceMetricStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAutoscalingV2beta2ResourceMetricStatus {
...
export function IoK8sApiAutoscalingV2beta2ResourceMetricStatusToJSON(value?: IoK8sApiAutoscalingV2beta2ResourceMetricStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
