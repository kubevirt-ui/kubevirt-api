...
export function IoK8sApiNodeV1beta1SchedulingFromJSON(json: any): IoK8sApiNodeV1beta1Scheduling {
    return IoK8sApiNodeV1beta1SchedulingFromJSONTyped(json, false);
}

export function IoK8sApiNodeV1beta1SchedulingFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiNodeV1beta1Scheduling {
...
export function IoK8sApiNodeV1beta1SchedulingToJSON(value?: IoK8sApiNodeV1beta1Scheduling | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
