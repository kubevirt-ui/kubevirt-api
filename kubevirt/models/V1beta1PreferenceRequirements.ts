...
export function V1beta1PreferenceRequirementsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    memory: !exists(json, 'memory')
      ? undefined
      : V1beta1MemoryPreferenceRequirementFromJSON(json['memory']),
  };
}

export function V1beta1PreferenceRequirementsToJSON(
  value?: V1beta1PreferenceRequirements | null,
): any {
  if (value === undefined) {
    return undefined;
  }
