...
export function IoK8sApiBatchV1beta1JobTemplateSpecFromJSON(
  json: any,
): IoK8sApiBatchV1beta1JobTemplateSpec {
  return IoK8sApiBatchV1beta1JobTemplateSpecFromJSONTyped(json, false);
}

export function IoK8sApiBatchV1beta1JobTemplateSpecFromJSONTyped(
  json: any,
...
export function IoK8sApiBatchV1beta1JobTemplateSpecToJSON(
  value?: IoK8sApiBatchV1beta1JobTemplateSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
