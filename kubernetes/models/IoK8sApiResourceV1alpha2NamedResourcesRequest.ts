...
export function IoK8sApiResourceV1alpha2NamedResourcesRequestFromJSON(json: any): IoK8sApiResourceV1alpha2NamedResourcesRequest {
    return IoK8sApiResourceV1alpha2NamedResourcesRequestFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2NamedResourcesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1alpha2NamedResourcesRequest {
...
export function IoK8sApiResourceV1alpha2NamedResourcesRequestToJSON(value?: IoK8sApiResourceV1alpha2NamedResourcesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
