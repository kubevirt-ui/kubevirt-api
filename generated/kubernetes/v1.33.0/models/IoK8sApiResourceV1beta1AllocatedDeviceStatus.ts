...
import {
    ...
    IoK8sApiResourceV1beta1NetworkDeviceDataFromJSONTyped,
 ...
 * @export
 * @interface IoK8sApiResourceV1beta1AllocatedDeviceStatus
 */
export interface IoK8sApiResourceV1beta1AllocatedDeviceStatus {
    ...
    /**
     * 
     * @type {IoK8sApiResourceV1beta1NetworkDeviceData}
     * @memberof IoK8sApiResourceV1beta1AllocatedDeviceStatus
     */
...
export function IoK8sApiResourceV1beta1AllocatedDeviceStatusFromJSON(json: any): IoK8sApiResourceV1beta1AllocatedDeviceStatus {
    return IoK8sApiResourceV1beta1AllocatedDeviceStatusFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta1AllocatedDeviceStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta1AllocatedDeviceStatus {
    ...
    return {
        ...
        'device': json['device'],
        'driver': json['driver'],
        'networkData': !exists(json, 'networkData') ? undefined : IoK8sApiResourceV1beta1NetworkDeviceDataFromJSON(json['networkData']),
        'pool': json['pool'],
    };
}

export function IoK8sApiResourceV1beta1AllocatedDeviceStatusToJSON(value?: IoK8sApiResourceV1beta1AllocatedDeviceStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
