...
import {
    ...
    V1VirtualMachineInterfaceRequestFromJSONTyped,
...
export function V1VirtualMachineStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1VirtualMachineStatus {
    ...
    return {
        ...
        'interfaceRequests': !exists(json, 'interfaceRequests') ? undefined : ((json['interfaceRequests'] as Array<any>).map(V1VirtualMachineInterfaceRequestFromJSON)),
...
export function V1VirtualMachineStatusToJSON(value?: V1VirtualMachineStatus | null): any {
    ...
    return {
        ...
        'interfaceRequests': value.interfaceRequests === undefined ? undefined : ((value.interfaceRequests as Array<any>).map(V1VirtualMachineInterfaceRequestToJSON)),
