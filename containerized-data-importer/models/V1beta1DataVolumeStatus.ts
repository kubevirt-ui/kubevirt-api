...
export function V1beta1DataVolumeStatusFromJSONTyped(
  json: any,
  ...
  return {
    ...
    conditions: !exists(json, 'conditions')
      ? undefined
      : (json['conditions'] as Array<any>).map(V1beta1DataVolumeConditionFromJSON),
  ...
  return {
    ...
    conditions:
      value.conditions === undefined
        ? undefined
        : (value.conditions as Array<any>).map(V1beta1DataVolumeConditionToJSON),
    phase: value.phase,
