...
export function IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerStatusFromJSON(
  json: any,
...
export function IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerStatusFromJSONTyped(
  json: any,
  ...
  return {
    ...
    currentMetrics: !exists(json, 'currentMetrics')
      ? undefined
      : (json['currentMetrics'] as Array<any>).map(IoK8sApiAutoscalingV2beta1MetricStatusFromJSON),
...
export function IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerStatusToJSON(
  value?: IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    currentMetrics:
      value.currentMetrics === undefined
        ? undefined
        : (value.currentMetrics as Array<any>).map(IoK8sApiAutoscalingV2beta1MetricStatusToJSON),
