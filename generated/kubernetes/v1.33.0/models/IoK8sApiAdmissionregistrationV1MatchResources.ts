...
import {
    ...
    IoK8sApiAdmissionregistrationV1NamedRuleWithOperationsFromJSONTyped,
...
export function IoK8sApiAdmissionregistrationV1MatchResourcesFromJSON(json: any): IoK8sApiAdmissionregistrationV1MatchResources {
    return IoK8sApiAdmissionregistrationV1MatchResourcesFromJSONTyped(json, false);
}

export function IoK8sApiAdmissionregistrationV1MatchResourcesFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAdmissionregistrationV1MatchResources {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'excludeResourceRules': !exists(json, 'excludeResourceRules') ? undefined : ((json['excludeResourceRules'] as Array<any>).map(IoK8sApiAdmissionregistrationV1NamedRuleWithOperationsFromJSON)),
        ...
        'resourceRules': !exists(json, 'resourceRules') ? undefined : ((json['resourceRules'] as Array<any>).map(IoK8sApiAdmissionregistrationV1NamedRuleWithOperationsFromJSON)),
    };
}

export function IoK8sApiAdmissionregistrationV1MatchResourcesToJSON(value?: IoK8sApiAdmissionregistrationV1MatchResources | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'excludeResourceRules': value.excludeResourceRules === undefined ? undefined : ((value.excludeResourceRules as Array<any>).map(IoK8sApiAdmissionregistrationV1NamedRuleWithOperationsToJSON)),
        ...
        'resourceRules': value.resourceRules === undefined ? undefined : ((value.resourceRules as Array<any>).map(IoK8sApiAdmissionregistrationV1NamedRuleWithOperationsToJSON)),
    };
}
