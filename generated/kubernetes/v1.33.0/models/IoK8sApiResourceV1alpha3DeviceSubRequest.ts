...
export function IoK8sApiResourceV1alpha3DeviceSubRequestFromJSON(json: any): IoK8sApiResourceV1alpha3DeviceSubRequest {
    return IoK8sApiResourceV1alpha3DeviceSubRequestFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha3DeviceSubRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1alpha3DeviceSubRequest {
...
export function IoK8sApiResourceV1alpha3DeviceSubRequestToJSON(value?: IoK8sApiResourceV1alpha3DeviceSubRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
