...
export function IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerFromJSON(
  json: any,
...
export function IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    spec: !exists(json, 'spec')
      ? undefined
      : IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerSpecFromJSON(json['spec']),
    status: !exists(json, 'status')
      ? undefined
      : IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerStatusFromJSON(json['status']),
  };
}

export function IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerToJSON(
  value?: IoK8sApiAutoscalingV2beta2HorizontalPodAutoscaler | null,
): any {
  if (value === undefined) {
    return undefined;
  }
