...
export function IoK8sApiNetworkingV1alpha1ServiceCIDRSpecFromJSON(
  json: any,
): IoK8sApiNetworkingV1alpha1ServiceCIDRSpec {
  return IoK8sApiNetworkingV1alpha1ServiceCIDRSpecFromJSONTyped(json, false);
}

export function IoK8sApiNetworkingV1alpha1ServiceCIDRSpecFromJSONTyped(
  json: any,
...
export function IoK8sApiNetworkingV1alpha1ServiceCIDRSpecToJSON(
  value?: IoK8sApiNetworkingV1alpha1ServiceCIDRSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
