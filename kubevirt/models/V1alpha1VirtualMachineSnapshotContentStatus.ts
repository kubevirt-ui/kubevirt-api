...
export function V1alpha1VirtualMachineSnapshotContentStatusFromJSONTyped(json: any, _ignoreDiscriminator: boolean): V1alpha1VirtualMachineSnapshotContentStatus {
