 ...
 */
export function instanceOfV1NodeNetworkConfigurationPolicySpec(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function V1NodeNetworkConfigurationPolicySpecFromJSON(json: any): V1NodeNetworkConfigurationPolicySpec {
    return V1NodeNetworkConfigurationPolicySpecFromJSONTyped(json, false);
}

export function V1NodeNetworkConfigurationPolicySpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1NodeNetworkConfigurationPolicySpec {
...
export function V1NodeNetworkConfigurationPolicySpecToJSON(value?: V1NodeNetworkConfigurationPolicySpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
