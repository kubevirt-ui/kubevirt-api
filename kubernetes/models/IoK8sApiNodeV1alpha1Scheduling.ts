...
export function IoK8sApiNodeV1alpha1SchedulingFromJSONTyped(
  json: any,
...
export function IoK8sApiNodeV1alpha1SchedulingToJSON(
  value?: IoK8sApiNodeV1alpha1Scheduling | null,
): any {
  if (value === undefined) {
    return undefined;
  }
