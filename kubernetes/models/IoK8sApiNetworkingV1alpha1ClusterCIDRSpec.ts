...
export function IoK8sApiNetworkingV1alpha1ClusterCIDRSpecFromJSON(
  json: any,
): IoK8sApiNetworkingV1alpha1ClusterCIDRSpec {
  return IoK8sApiNetworkingV1alpha1ClusterCIDRSpecFromJSONTyped(json, false);
}

export function IoK8sApiNetworkingV1alpha1ClusterCIDRSpecFromJSONTyped(
  json: any,
...
export function IoK8sApiNetworkingV1alpha1ClusterCIDRSpecToJSON(
  value?: IoK8sApiNetworkingV1alpha1ClusterCIDRSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
