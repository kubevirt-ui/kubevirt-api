...
export class AuthenticationV1alpha1Api extends runtime.BaseAPI {
   ...
   */
  async createAuthenticationV1alpha1SelfSubjectReviewRaw(
    requestParameters: CreateAuthenticationV1alpha1SelfSubjectReviewRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApiAuthenticationV1alpha1SelfSubjectReview>> {
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new runtime.RequiredError(
        'body',
        'Required parameter requestParameters.body was null or undefined when calling createAuthenticationV1alpha1SelfSubjectReview.',
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      IoK8sApiAuthenticationV1alpha1SelfSubjectReviewFromJSON(jsonValue),
    );
  }
  ...
  async createAuthenticationV1alpha1SelfSubjectReview(
    ...
    const response = await this.createAuthenticationV1alpha1SelfSubjectReviewRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async getAuthenticationV1alpha1APIResourcesRaw(
    initOverrides?: RequestInit,
