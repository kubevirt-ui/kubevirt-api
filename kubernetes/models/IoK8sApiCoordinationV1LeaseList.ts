...
export function IoK8sApiCoordinationV1LeaseListFromJSON(
  json: any,
): IoK8sApiCoordinationV1LeaseList {
  return IoK8sApiCoordinationV1LeaseListFromJSONTyped(json, false);
}

export function IoK8sApiCoordinationV1LeaseListFromJSONTyped(
  json: any,
...
export function IoK8sApiCoordinationV1LeaseListToJSON(
  value?: IoK8sApiCoordinationV1LeaseList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
