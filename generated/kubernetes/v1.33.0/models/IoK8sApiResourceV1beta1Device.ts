...
export function IoK8sApiResourceV1beta1DeviceFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta1Device {
    ...
    return {
        ...
        'basic': !exists(json, 'basic') ? undefined : IoK8sApiResourceV1beta1BasicDeviceFromJSON(json['basic']),
        'name': json['name'],
    };
}

export function IoK8sApiResourceV1beta1DeviceToJSON(value?: IoK8sApiResourceV1beta1Device | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
