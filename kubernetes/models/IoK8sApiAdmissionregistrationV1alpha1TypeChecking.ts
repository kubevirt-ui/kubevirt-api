...
export function IoK8sApiAdmissionregistrationV1alpha1TypeCheckingFromJSON(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1alpha1TypeCheckingFromJSONTyped(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1alpha1TypeCheckingToJSON(
  value?: IoK8sApiAdmissionregistrationV1alpha1TypeChecking | null,
): any {
  if (value === undefined) {
    return undefined;
  }
