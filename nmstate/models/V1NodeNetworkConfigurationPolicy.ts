...
import { V1NodeNetworkConfigurationPolicySpec } from './V1NodeNetworkConfigurationPolicySpec';
import { V1NodeNetworkConfigurationPolicyStatus } from './V1NodeNetworkConfigurationPolicyStatus';
...
More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   ...
   *
   * @required {false}
   * @originalType {V1NodeNetworkConfigurationPolicyMetadata}
   */
