...
export function IoK8sApiFlowcontrolV1UserSubjectFromJSON(
  json: any,
): IoK8sApiFlowcontrolV1UserSubject {
  return IoK8sApiFlowcontrolV1UserSubjectFromJSONTyped(json, false);
}

export function IoK8sApiFlowcontrolV1UserSubjectFromJSONTyped(
  json: any,
...
export function IoK8sApiFlowcontrolV1UserSubjectToJSON(
  value?: IoK8sApiFlowcontrolV1UserSubject | null,
): any {
  if (value === undefined) {
    return undefined;
  }
