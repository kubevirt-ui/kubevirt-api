...
export function V1alpha1VirtualMachineCloneListFromJSON(
  json: any,
): V1alpha1VirtualMachineCloneList {
  return V1alpha1VirtualMachineCloneListFromJSONTyped(json, false);
}

export function V1alpha1VirtualMachineCloneListFromJSONTyped(
  json: any,
...
export function V1alpha1VirtualMachineCloneListToJSON(
  value?: V1alpha1VirtualMachineCloneList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
