...
export class AuthenticationV1Api extends runtime.BaseAPI {
   ...
   */
  async createAuthenticationV1TokenReviewRaw(
    requestParameters: CreateAuthenticationV1TokenReviewRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApiAuthenticationV1TokenReview>> {
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new runtime.RequiredError(
        'body',
        'Required parameter requestParameters.body was null or undefined when calling createAuthenticationV1TokenReview.',
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      IoK8sApiAuthenticationV1TokenReviewFromJSON(jsonValue),
    );
  }
  ...
  async createAuthenticationV1TokenReview(
    ...
    const response = await this.createAuthenticationV1TokenReviewRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async getAuthenticationV1APIResourcesRaw(
    initOverrides?: RequestInit,
