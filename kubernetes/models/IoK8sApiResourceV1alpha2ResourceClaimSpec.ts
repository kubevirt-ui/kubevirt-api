...
export function IoK8sApiResourceV1alpha2ResourceClaimSpecFromJSON(
  json: any,
): IoK8sApiResourceV1alpha2ResourceClaimSpec {
  return IoK8sApiResourceV1alpha2ResourceClaimSpecFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2ResourceClaimSpecFromJSONTyped(
  json: any,
  ...
  return {
    ...
    parametersRef: !exists(json, 'parametersRef')
      ? undefined
      : IoK8sApiResourceV1alpha2ResourceClaimParametersReferenceFromJSON(json['parametersRef']),
    resourceClassName: json['resourceClassName'],
  };
}

export function IoK8sApiResourceV1alpha2ResourceClaimSpecToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClaimSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
