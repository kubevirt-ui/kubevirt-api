 ...
 * @export
 */
export interface V1beta1NodeNetworkConfigurationPolicySpec {
  /** capture
   * Capture contains expressions with an associated name than can be referenced
at the DesiredState.
   *
   * @required {false}
   * @originalType {V1beta1NodeNetworkConfigurationPolicySpecCapture}
   */
...
More info: https://kubernetes.io/docs/concepts/configuration/assign-pod-node/
   *
   * @required {false}
   * @originalType {V1beta1NodeNetworkConfigurationPolicySpecNodeSelector}
   */
