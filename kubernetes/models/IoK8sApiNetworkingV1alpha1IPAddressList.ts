...
export function IoK8sApiNetworkingV1alpha1IPAddressListFromJSON(
  json: any,
): IoK8sApiNetworkingV1alpha1IPAddressList {
  return IoK8sApiNetworkingV1alpha1IPAddressListFromJSONTyped(json, false);
}

export function IoK8sApiNetworkingV1alpha1IPAddressListFromJSONTyped(
  json: any,
...
export function IoK8sApiNetworkingV1alpha1IPAddressListToJSON(
  value?: IoK8sApiNetworkingV1alpha1IPAddressList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
