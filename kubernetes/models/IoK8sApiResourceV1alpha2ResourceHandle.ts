...
export function IoK8sApiResourceV1alpha2ResourceHandleFromJSON(
  json: any,
): IoK8sApiResourceV1alpha2ResourceHandle {
  return IoK8sApiResourceV1alpha2ResourceHandleFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2ResourceHandleFromJSONTyped(
  json: any,
  ...
  return {
    ...
    structuredData: !exists(json, 'structuredData')
      ? undefined
      : IoK8sApiResourceV1alpha2StructuredResourceHandleFromJSON(json['structuredData']),
  };
}

export function IoK8sApiResourceV1alpha2ResourceHandleToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceHandle | null,
): any {
  if (value === undefined) {
    return undefined;
  }
