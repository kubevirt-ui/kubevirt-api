...
import {
  ...
  V1NMStateSpecAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionFromJSON,
  V1NMStateSpecAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionFromJSONTyped,
  V1NMStateSpecAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionToJSON,
...
export interface V1NMStateSpecAffinityNodeAffinity {
   ...
   * @type {Array<V1NMStateSpecAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution>}
   * @memberof V1NMStateSpecAffinityNodeAffinity
   */
  preferredDuringSchedulingIgnoredDuringExecution?: Array<V1NMStateSpecAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution>;
  /**
   *
