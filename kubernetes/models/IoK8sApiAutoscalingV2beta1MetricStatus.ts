...
export function IoK8sApiAutoscalingV2beta1MetricStatusFromJSON(
  json: any,
): IoK8sApiAutoscalingV2beta1MetricStatus {
  return IoK8sApiAutoscalingV2beta1MetricStatusFromJSONTyped(json, false);
}

export function IoK8sApiAutoscalingV2beta1MetricStatusFromJSONTyped(
  json: any,
  ...
  return {
    containerResource: !exists(json, 'containerResource')
      ? undefined
      : IoK8sApiAutoscalingV2beta1ContainerResourceMetricStatusFromJSON(json['containerResource']),
    external: !exists(json, 'external')
      ? undefined
      : IoK8sApiAutoscalingV2beta1ExternalMetricStatusFromJSON(json['external']),
    object: !exists(json, 'object')
      ? undefined
      : IoK8sApiAutoscalingV2beta1ObjectMetricStatusFromJSON(json['object']),
    pods: !exists(json, 'pods')
      ? undefined
      : IoK8sApiAutoscalingV2beta1PodsMetricStatusFromJSON(json['pods']),
    resource: !exists(json, 'resource')
      ? undefined
      : IoK8sApiAutoscalingV2beta1ResourceMetricStatusFromJSON(json['resource']),
    type: json['type'],
  };
}

export function IoK8sApiAutoscalingV2beta1MetricStatusToJSON(
  value?: IoK8sApiAutoscalingV2beta1MetricStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    containerResource: IoK8sApiAutoscalingV2beta1ContainerResourceMetricStatusToJSON(
