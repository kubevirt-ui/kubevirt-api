...
export function IoK8sApiResourceV1alpha2ResourceClaimSchedulingStatusFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClaimSchedulingStatusFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClaimSchedulingStatusToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClaimSchedulingStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
