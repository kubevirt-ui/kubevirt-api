...
export function IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationSpecFromJSON(
  json: any,
...
export function IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationSpecFromJSONTyped(
  json: any,
...
export function IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationSpecToJSON(
  value?: IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
