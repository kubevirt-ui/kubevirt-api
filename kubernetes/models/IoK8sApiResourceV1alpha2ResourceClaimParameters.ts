...
export function IoK8sApiResourceV1alpha2ResourceClaimParametersFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClaimParametersFromJSONTyped(
  json: any,
  ...
  return {
    ...
    driverRequests: !exists(json, 'driverRequests')
      ? undefined
      : (json['driverRequests'] as Array<any>).map(IoK8sApiResourceV1alpha2DriverRequestsFromJSON),
    generatedFrom: !exists(json, 'generatedFrom')
      ? undefined
      : IoK8sApiResourceV1alpha2ResourceClaimParametersReferenceFromJSON(json['generatedFrom']),
...
export function IoK8sApiResourceV1alpha2ResourceClaimParametersToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClaimParameters | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    driverRequests:
      value.driverRequests === undefined
        ? undefined
        : (value.driverRequests as Array<any>).map(IoK8sApiResourceV1alpha2DriverRequestsToJSON),
    generatedFrom: IoK8sApiResourceV1alpha2ResourceClaimParametersReferenceToJSON(
      value.generatedFrom,
    ),
    kind: value.kind,
