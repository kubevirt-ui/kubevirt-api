...
export function IoK8sApiResourceV1alpha2ResourceClassFromJSON(
  json: any,
): IoK8sApiResourceV1alpha2ResourceClass {
  return IoK8sApiResourceV1alpha2ResourceClassFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2ResourceClassFromJSONTyped(
  json: any,
  ...
  return {
    ...
    parametersRef: !exists(json, 'parametersRef')
      ? undefined
      : IoK8sApiResourceV1alpha2ResourceClassParametersReferenceFromJSON(json['parametersRef']),
    structuredParameters: !exists(json, 'structuredParameters')
      ? undefined
      : json['structuredParameters'],
...
export function IoK8sApiResourceV1alpha2ResourceClassToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClass | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    parametersRef: IoK8sApiResourceV1alpha2ResourceClassParametersReferenceToJSON(
      value.parametersRef,
    ),
    structuredParameters: value.structuredParameters,
