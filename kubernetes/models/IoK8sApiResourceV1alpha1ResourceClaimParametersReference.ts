...
export function IoK8sApiResourceV1alpha1ResourceClaimParametersReferenceFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha1ResourceClaimParametersReferenceFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha1ResourceClaimParametersReferenceToJSON(
  value?: IoK8sApiResourceV1alpha1ResourceClaimParametersReference | null,
): any {
  if (value === undefined) {
    return undefined;
  }
