...
import {
    ...
    IoK8sApiBatchV1beta1JobTemplateSpecFromJSONTyped,
...
export interface IoK8sApiBatchV1beta1CronJobSpec {
     ...
     * @type {string}
     * @memberof IoK8sApiBatchV1beta1CronJobSpec
     */
...
export function IoK8sApiBatchV1beta1CronJobSpecFromJSON(json: any): IoK8sApiBatchV1beta1CronJobSpec {
    return IoK8sApiBatchV1beta1CronJobSpecFromJSONTyped(json, false);
}

export function IoK8sApiBatchV1beta1CronJobSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiBatchV1beta1CronJobSpec {
    ...
    return {
        ...
        'jobTemplate': IoK8sApiBatchV1beta1JobTemplateSpecFromJSON(json['jobTemplate']),
...
export function IoK8sApiBatchV1beta1CronJobSpecToJSON(value?: IoK8sApiBatchV1beta1CronJobSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'jobTemplate': IoK8sApiBatchV1beta1JobTemplateSpecToJSON(value.jobTemplate),
