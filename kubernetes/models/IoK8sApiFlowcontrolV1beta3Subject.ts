...
export function IoK8sApiFlowcontrolV1beta3SubjectFromJSON(
  json: any,
): IoK8sApiFlowcontrolV1beta3Subject {
  return IoK8sApiFlowcontrolV1beta3SubjectFromJSONTyped(json, false);
}

export function IoK8sApiFlowcontrolV1beta3SubjectFromJSONTyped(
  json: any,
  ...
  return {
    group: !exists(json, 'group')
      ? undefined
      : IoK8sApiFlowcontrolV1beta3GroupSubjectFromJSON(json['group']),
    kind: json['kind'],
    serviceAccount: !exists(json, 'serviceAccount')
      ? undefined
      : IoK8sApiFlowcontrolV1beta3ServiceAccountSubjectFromJSON(json['serviceAccount']),
    user: !exists(json, 'user')
      ? undefined
      : IoK8sApiFlowcontrolV1beta3UserSubjectFromJSON(json['user']),
  };
}

export function IoK8sApiFlowcontrolV1beta3SubjectToJSON(
  value?: IoK8sApiFlowcontrolV1beta3Subject | null,
): any {
  if (value === undefined) {
    return undefined;
  }
