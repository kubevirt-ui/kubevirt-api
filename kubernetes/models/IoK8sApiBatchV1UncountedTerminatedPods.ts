...
export function IoK8sApiBatchV1UncountedTerminatedPodsFromJSON(
  json: any,
): IoK8sApiBatchV1UncountedTerminatedPods {
  return IoK8sApiBatchV1UncountedTerminatedPodsFromJSONTyped(json, false);
}

export function IoK8sApiBatchV1UncountedTerminatedPodsFromJSONTyped(
  json: any,
...
export function IoK8sApiBatchV1UncountedTerminatedPodsToJSON(
  value?: IoK8sApiBatchV1UncountedTerminatedPods | null,
): any {
  if (value === undefined) {
    return undefined;
  }
