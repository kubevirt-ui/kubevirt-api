...
export function IoK8sApiFlowcontrolV1beta3FlowDistinguisherMethodFromJSON(
  json: any,
...
export function IoK8sApiFlowcontrolV1beta3FlowDistinguisherMethodFromJSONTyped(
  json: any,
...
export function IoK8sApiFlowcontrolV1beta3FlowDistinguisherMethodToJSON(
  value?: IoK8sApiFlowcontrolV1beta3FlowDistinguisherMethod | null,
): any {
  if (value === undefined) {
    return undefined;
  }
