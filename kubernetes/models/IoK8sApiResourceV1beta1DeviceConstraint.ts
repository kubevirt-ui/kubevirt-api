...
export function IoK8sApiResourceV1beta1DeviceConstraintFromJSON(
  json: any,
): IoK8sApiResourceV1beta1DeviceConstraint {
  return IoK8sApiResourceV1beta1DeviceConstraintFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta1DeviceConstraintFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1beta1DeviceConstraintToJSON(
  value?: IoK8sApiResourceV1beta1DeviceConstraint | null,
): any {
  if (value === undefined) {
    return undefined;
  }
