...
export function IoK8sApiCertificatesV1alpha1ClusterTrustBundleFromJSON(
  json: any,
...
export function IoK8sApiCertificatesV1alpha1ClusterTrustBundleFromJSONTyped(
  json: any,
...
export function IoK8sApiCertificatesV1alpha1ClusterTrustBundleToJSON(
  value?: IoK8sApiCertificatesV1alpha1ClusterTrustBundle | null,
): any {
  if (value === undefined) {
    return undefined;
  }
