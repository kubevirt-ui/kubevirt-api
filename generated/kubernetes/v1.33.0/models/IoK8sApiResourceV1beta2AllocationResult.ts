...
export function IoK8sApiResourceV1beta2AllocationResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta2AllocationResult {
    ...
    return {
        ...
        'devices': !exists(json, 'devices') ? undefined : IoK8sApiResourceV1beta2DeviceAllocationResultFromJSON(json['devices']),
        'nodeSelector': !exists(json, 'nodeSelector') ? undefined : IoK8sApiCoreV1NodeSelectorFromJSON(json['nodeSelector']),
    };
}

export function IoK8sApiResourceV1beta2AllocationResultToJSON(value?: IoK8sApiResourceV1beta2AllocationResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
