...
export function IoK8sApiResourceV1alpha2ResourceClassListFromJSON(
  json: any,
): IoK8sApiResourceV1alpha2ResourceClassList {
  return IoK8sApiResourceV1alpha2ResourceClassListFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2ResourceClassListFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClassListToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClassList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
