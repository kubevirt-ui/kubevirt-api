...
export const VirtualMachineInstanceModelGroupVersionKind =
  modelToGroupVersionKind(VirtualMachineInstanceModel);
export const VirtualMachineInstanceModelRef = modelToRef(
