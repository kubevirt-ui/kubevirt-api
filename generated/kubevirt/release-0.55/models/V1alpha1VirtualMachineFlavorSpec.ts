...
export function V1alpha1VirtualMachineFlavorSpecFromJSON(json: any): V1alpha1VirtualMachineFlavorSpec {
    return V1alpha1VirtualMachineFlavorSpecFromJSONTyped(json, false);
}

export function V1alpha1VirtualMachineFlavorSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1alpha1VirtualMachineFlavorSpec {
...
export function V1alpha1VirtualMachineFlavorSpecToJSON(value?: V1alpha1VirtualMachineFlavorSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
