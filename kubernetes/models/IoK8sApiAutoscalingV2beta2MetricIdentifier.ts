...
export function IoK8sApiAutoscalingV2beta2MetricIdentifierFromJSON(
  json: any,
): IoK8sApiAutoscalingV2beta2MetricIdentifier {
  return IoK8sApiAutoscalingV2beta2MetricIdentifierFromJSONTyped(json, false);
}

export function IoK8sApiAutoscalingV2beta2MetricIdentifierFromJSONTyped(
  json: any,
...
export function IoK8sApiAutoscalingV2beta2MetricIdentifierToJSON(
  value?: IoK8sApiAutoscalingV2beta2MetricIdentifier | null,
): any {
  if (value === undefined) {
    return undefined;
  }
