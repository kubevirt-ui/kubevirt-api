...
export function IoK8sApiResourceV1alpha2ResourceClaimTemplateSpecFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClaimTemplateSpecFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClaimTemplateSpecToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClaimTemplateSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
