...
export function IoK8sApiNetworkingV1NetworkPolicyStatusFromJSON(json: any): IoK8sApiNetworkingV1NetworkPolicyStatus {
    return IoK8sApiNetworkingV1NetworkPolicyStatusFromJSONTyped(json, false);
}

export function IoK8sApiNetworkingV1NetworkPolicyStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiNetworkingV1NetworkPolicyStatus {
...
export function IoK8sApiNetworkingV1NetworkPolicyStatusToJSON(value?: IoK8sApiNetworkingV1NetworkPolicyStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
