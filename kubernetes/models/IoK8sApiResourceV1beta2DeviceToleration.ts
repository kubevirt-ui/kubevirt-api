...
export function IoK8sApiResourceV1beta2DeviceTolerationFromJSON(
  json: any,
): IoK8sApiResourceV1beta2DeviceToleration {
  return IoK8sApiResourceV1beta2DeviceTolerationFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta2DeviceTolerationFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1beta2DeviceTolerationToJSON(
  value?: IoK8sApiResourceV1beta2DeviceToleration | null,
): any {
  if (value === undefined) {
    return undefined;
  }
