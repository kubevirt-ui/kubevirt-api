...
import {
    ...
    IoK8sApiResourceV1alpha2ResourceFilterFromJSONTyped,
    ...
    IoK8sApiResourceV1alpha2VendorParametersFromJSONTyped,
...
export function IoK8sApiResourceV1alpha2ResourceClassParametersFromJSON(json: any): IoK8sApiResourceV1alpha2ResourceClassParameters {
    return IoK8sApiResourceV1alpha2ResourceClassParametersFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2ResourceClassParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1alpha2ResourceClassParameters {
    ...
    return {
        ...
        'filters': !exists(json, 'filters') ? undefined : ((json['filters'] as Array<any>).map(IoK8sApiResourceV1alpha2ResourceFilterFromJSON)),
        'generatedFrom': !exists(json, 'generatedFrom') ? undefined : IoK8sApiResourceV1alpha2ResourceClassParametersReferenceFromJSON(json['generatedFrom']),
        'kind': !exists(json, 'kind') ? undefined : json['kind'],
        'metadata': !exists(json, 'metadata') ? undefined : IoK8sApimachineryPkgApisMetaV1ObjectMetaFromJSON(json['metadata']),
        'vendorParameters': !exists(json, 'vendorParameters') ? undefined : ((json['vendorParameters'] as Array<any>).map(IoK8sApiResourceV1alpha2VendorParametersFromJSON)),
    };
}

export function IoK8sApiResourceV1alpha2ResourceClassParametersToJSON(value?: IoK8sApiResourceV1alpha2ResourceClassParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'filters': value.filters === undefined ? undefined : ((value.filters as Array<any>).map(IoK8sApiResourceV1alpha2ResourceFilterToJSON)),
        'generatedFrom': IoK8sApiResourceV1alpha2ResourceClassParametersReferenceToJSON(value.generatedFrom),
        'kind': value.kind,
        'metadata': IoK8sApimachineryPkgApisMetaV1ObjectMetaToJSON(value.metadata),
        'vendorParameters': value.vendorParameters === undefined ? undefined : ((value.vendorParameters as Array<any>).map(IoK8sApiResourceV1alpha2VendorParametersToJSON)),
    };
}
