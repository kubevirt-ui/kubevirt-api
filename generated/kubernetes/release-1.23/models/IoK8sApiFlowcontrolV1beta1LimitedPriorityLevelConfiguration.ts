...
import {
    ...
    IoK8sApiFlowcontrolV1beta1LimitResponseFromJSONTyped,
...
export function IoK8sApiFlowcontrolV1beta1LimitedPriorityLevelConfigurationFromJSON(json: any): IoK8sApiFlowcontrolV1beta1LimitedPriorityLevelConfiguration {
    return IoK8sApiFlowcontrolV1beta1LimitedPriorityLevelConfigurationFromJSONTyped(json, false);
}

export function IoK8sApiFlowcontrolV1beta1LimitedPriorityLevelConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiFlowcontrolV1beta1LimitedPriorityLevelConfiguration {
    ...
    return {
        ...
        'limitResponse': !exists(json, 'limitResponse') ? undefined : IoK8sApiFlowcontrolV1beta1LimitResponseFromJSON(json['limitResponse']),
    };
}

export function IoK8sApiFlowcontrolV1beta1LimitedPriorityLevelConfigurationToJSON(value?: IoK8sApiFlowcontrolV1beta1LimitedPriorityLevelConfiguration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
