...
export function IoK8sApiEventsV1beta1EventSeriesFromJSON(
  json: any,
): IoK8sApiEventsV1beta1EventSeries {
  return IoK8sApiEventsV1beta1EventSeriesFromJSONTyped(json, false);
}

export function IoK8sApiEventsV1beta1EventSeriesFromJSONTyped(
  json: any,
...
export function IoK8sApiEventsV1beta1EventSeriesToJSON(
  value?: IoK8sApiEventsV1beta1EventSeries | null,
): any {
  if (value === undefined) {
    return undefined;
  }
