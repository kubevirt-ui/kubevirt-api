...
import {
    ...
    IoK8sApiResourceV1beta2DeviceAttributeFromJSONTyped,
    ...
    IoK8sApiResourceV1beta2DeviceCapacityFromJSONTyped,
    ...
    IoK8sApiResourceV1beta2DeviceCounterConsumptionFromJSONTyped,
...
export function IoK8sApiResourceV1beta2DeviceFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta2Device {
    ...
    return {
        ...
        'attributes': !exists(json, 'attributes') ? undefined : (mapValues(json['attributes'], IoK8sApiResourceV1beta2DeviceAttributeFromJSON)),
        'capacity': !exists(json, 'capacity') ? undefined : (mapValues(json['capacity'], IoK8sApiResourceV1beta2DeviceCapacityFromJSON)),
        'consumesCounters': !exists(json, 'consumesCounters') ? undefined : ((json['consumesCounters'] as Array<any>).map(IoK8sApiResourceV1beta2DeviceCounterConsumptionFromJSON)),
        'name': json['name'],
        ...
        'taints': !exists(json, 'taints') ? undefined : ((json['taints'] as Array<any>).map(IoK8sApiResourceV1beta2DeviceTaintFromJSON)),
    };
}

export function IoK8sApiResourceV1beta2DeviceToJSON(value?: IoK8sApiResourceV1beta2Device | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'attributes': value.attributes === undefined ? undefined : (mapValues(value.attributes, IoK8sApiResourceV1beta2DeviceAttributeToJSON)),
        'capacity': value.capacity === undefined ? undefined : (mapValues(value.capacity, IoK8sApiResourceV1beta2DeviceCapacityToJSON)),
        'consumesCounters': value.consumesCounters === undefined ? undefined : ((value.consumesCounters as Array<any>).map(IoK8sApiResourceV1beta2DeviceCounterConsumptionToJSON)),
        'name': value.name,
        'nodeName': value.nodeName,
        'nodeSelector': IoK8sApiCoreV1NodeSelectorToJSON(value.nodeSelector),
        'taints': value.taints === undefined ? undefined : ((value.taints as Array<any>).map(IoK8sApiResourceV1beta2DeviceTaintToJSON)),
    };
}
