...
export function IoK8sApiResourceV1alpha2ResourceClassParametersListFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClassParametersListFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClassParametersListToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClassParametersList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
