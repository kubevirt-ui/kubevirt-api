...
export function K8sIoApimachineryPkgApisMetaV1ManagedFieldsEntryFromJSON(
  json: any,
...
export function K8sIoApimachineryPkgApisMetaV1ManagedFieldsEntryFromJSONTyped(
  json: any,
...
export function K8sIoApimachineryPkgApisMetaV1ManagedFieldsEntryToJSON(
  value?: K8sIoApimachineryPkgApisMetaV1ManagedFieldsEntry | null,
): any {
  if (value === undefined) {
    return undefined;
  }
