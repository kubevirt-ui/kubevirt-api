...
export function IoK8sApiBatchV1beta1CronJobSpecFromJSON(
  json: any,
): IoK8sApiBatchV1beta1CronJobSpec {
  return IoK8sApiBatchV1beta1CronJobSpecFromJSONTyped(json, false);
}

export function IoK8sApiBatchV1beta1CronJobSpecFromJSONTyped(
  json: any,
...
export function IoK8sApiBatchV1beta1CronJobSpecToJSON(
  value?: IoK8sApiBatchV1beta1CronJobSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
