...
export function IoK8sApiResourceV1alpha3DeviceClaimConfigurationFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha3DeviceClaimConfigurationFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha3DeviceClaimConfigurationToJSON(
  value?: IoK8sApiResourceV1alpha3DeviceClaimConfiguration | null,
): any {
  if (value === undefined) {
    return undefined;
  }
