...
import {
    ...
    V1alpha1BackupCheckpointFromJSON,
    V1alpha1BackupCheckpointToJSON,
...
export interface V1RedefineCheckpointRequest {
    name: string;
    namespace: string;
    body: V1alpha1BackupCheckpoint;
}
...
export interface V1alpha3RedefineCheckpointRequest {
    name: string;
    namespace: string;
    body: V1alpha1BackupCheckpoint;
}
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async v1RedefineCheckpointRaw(requestParameters: V1RedefineCheckpointRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling v1RedefineCheckpoint.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling v1RedefineCheckpoint.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling v1RedefineCheckpoint.');
        }
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace}/virtualmachineinstances/{name}/redefine-checkpoint`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1alpha1BackupCheckpointToJSON(requestParameters.body),
        }, initOverrides);
     ...
     * Redefine a checkpoint for a VirtualMachineInstance.
     */
    async v1RedefineCheckpoint(requestParameters: V1RedefineCheckpointRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.v1RedefineCheckpointRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Redefine a checkpoint for a VirtualMachineInstance.
     */
    async v1alpha3RedefineCheckpointRaw(requestParameters: V1alpha3RedefineCheckpointRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling v1alpha3RedefineCheckpoint.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling v1alpha3RedefineCheckpoint.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling v1alpha3RedefineCheckpoint.');
        }
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace}/virtualmachineinstances/{name}/redefine-checkpoint`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: V1alpha1BackupCheckpointToJSON(requestParameters.body),
     ...
     * Redefine a checkpoint for a VirtualMachineInstance.
     */
    async v1alpha3RedefineCheckpoint(requestParameters: V1alpha3RedefineCheckpointRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.v1alpha3RedefineCheckpointRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async v1alpha3vmObjectgraphRaw(requestParameters: V1alpha3vmObjectgraphRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1ObjectGraphNode>> {
        ...
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling v1alpha3vmObjectgraph.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling v1alpha3vmObjectgraph.');
        }
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace}/virtualmachines/{name}/objectgraph`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1ObjectGraphNodeFromJSON(jsonValue));
    }
    ...
    async v1alpha3vmiObjectgraphRaw(requestParameters: V1alpha3vmiObjectgraphRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1ObjectGraphNode>> {
        ...
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling v1alpha3vmiObjectgraph.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling v1alpha3vmiObjectgraph.');
        }
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace}/virtualmachineinstances/{name}/objectgraph`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
            body: V1ObjectGraphOptionsToJSON(requestParameters.body),
    ...
    async v1vmObjectgraphRaw(requestParameters: V1vmObjectgraphRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1ObjectGraphNode>> {
        ...
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling v1vmObjectgraph.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling v1vmObjectgraph.');
        }
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace}/virtualmachines/{name}/objectgraph`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
            body: V1ObjectGraphOptionsToJSON(requestParameters.body),
    ...
    async v1vmiObjectgraphRaw(requestParameters: V1vmiObjectgraphRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1ObjectGraphNode>> {
        ...
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling v1vmiObjectgraph.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling v1vmiObjectgraph.');
        }
        ...
        const response = await this.request({
            path: `/apis/subresources.kubevirt.io/v1/namespaces/{namespace}/virtualmachineinstances/{name}/objectgraph`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
            body: V1ObjectGraphOptionsToJSON(requestParameters.body),
