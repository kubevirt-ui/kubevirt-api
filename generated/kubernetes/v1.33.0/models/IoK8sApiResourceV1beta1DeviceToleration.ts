...
export function IoK8sApiResourceV1beta1DeviceTolerationFromJSON(json: any): IoK8sApiResourceV1beta1DeviceToleration {
    return IoK8sApiResourceV1beta1DeviceTolerationFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1beta1DeviceTolerationFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1beta1DeviceToleration {
...
export function IoK8sApiResourceV1beta1DeviceTolerationToJSON(value?: IoK8sApiResourceV1beta1DeviceToleration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
