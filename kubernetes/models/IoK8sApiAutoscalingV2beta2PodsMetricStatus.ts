...
export function IoK8sApiAutoscalingV2beta2PodsMetricStatusFromJSON(
  json: any,
): IoK8sApiAutoscalingV2beta2PodsMetricStatus {
  return IoK8sApiAutoscalingV2beta2PodsMetricStatusFromJSONTyped(json, false);
}

export function IoK8sApiAutoscalingV2beta2PodsMetricStatusFromJSONTyped(
  json: any,
...
export function IoK8sApiAutoscalingV2beta2PodsMetricStatusToJSON(
  value?: IoK8sApiAutoscalingV2beta2PodsMetricStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
