...
export function V1alpha1VirtualMachineSnapshotContentSpecFromJSONTyped(json: any, _ignoreDiscriminator: boolean): V1alpha1VirtualMachineSnapshotContentSpec {
