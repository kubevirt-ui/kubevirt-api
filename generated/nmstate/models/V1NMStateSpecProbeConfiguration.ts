...
import {
    ...
    V1NMStateSpecProbeConfigurationDnsFromJSONTyped,
 ...
 */
export function instanceOfV1NMStateSpecProbeConfiguration(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function V1NMStateSpecProbeConfigurationFromJSON(json: any): V1NMStateSpecProbeConfiguration {
    return V1NMStateSpecProbeConfigurationFromJSONTyped(json, false);
}

export function V1NMStateSpecProbeConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1NMStateSpecProbeConfiguration {
...
export function V1NMStateSpecProbeConfigurationToJSON(value?: V1NMStateSpecProbeConfiguration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
