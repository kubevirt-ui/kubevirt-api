...
export function V1alpha2VirtualMachinePreferenceSpecFromJSONTyped(
  json: any,
  ...
  return {
    ...
    devices: !exists(json, 'devices')
      ? undefined
      : V1alpha2DevicePreferencesFromJSON(json['devices']),
    features: !exists(json, 'features')
      ? undefined
      : V1alpha2FeaturePreferencesFromJSON(json['features']),
    firmware: !exists(json, 'firmware')
      ? undefined
      : V1alpha2FirmwarePreferencesFromJSON(json['firmware']),
...
export function V1alpha2VirtualMachinePreferenceSpecToJSON(
  value?: V1alpha2VirtualMachinePreferenceSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
