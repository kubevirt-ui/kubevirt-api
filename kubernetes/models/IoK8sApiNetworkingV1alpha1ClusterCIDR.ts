...
export function IoK8sApiNetworkingV1alpha1ClusterCIDRFromJSON(
  json: any,
): IoK8sApiNetworkingV1alpha1ClusterCIDR {
  return IoK8sApiNetworkingV1alpha1ClusterCIDRFromJSONTyped(json, false);
}

export function IoK8sApiNetworkingV1alpha1ClusterCIDRFromJSONTyped(
  json: any,
  ...
  return {
    ...
    spec: !exists(json, 'spec')
      ? undefined
      : IoK8sApiNetworkingV1alpha1ClusterCIDRSpecFromJSON(json['spec']),
  };
}

export function IoK8sApiNetworkingV1alpha1ClusterCIDRToJSON(
  value?: IoK8sApiNetworkingV1alpha1ClusterCIDR | null,
): any {
  if (value === undefined) {
    return undefined;
  }
