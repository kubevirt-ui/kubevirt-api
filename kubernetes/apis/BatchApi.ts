...
export class BatchApi extends runtime.BaseAPI {
     ...
     */
    async getBatchAPIGroupRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getBatchAPIGroup(initOverrides?: RequestInit): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
