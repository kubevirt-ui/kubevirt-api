...
export function IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleFromJSON(
  json: any,
): IoK8sApiFlowcontrolV1beta3ResourcePolicyRule {
  return IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleFromJSONTyped(json, false);
}

export function IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleFromJSONTyped(
  json: any,
...
export function IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleToJSON(
  value?: IoK8sApiFlowcontrolV1beta3ResourcePolicyRule | null,
): any {
  if (value === undefined) {
    return undefined;
  }
