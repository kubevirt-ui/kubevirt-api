...
export function IoK8sApiResourceV1alpha3DeviceAllocationConfigurationFromJSON(json: any): IoK8sApiResourceV1alpha3DeviceAllocationConfiguration {
    return IoK8sApiResourceV1alpha3DeviceAllocationConfigurationFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha3DeviceAllocationConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1alpha3DeviceAllocationConfiguration {
...
export function IoK8sApiResourceV1alpha3DeviceAllocationConfigurationToJSON(value?: IoK8sApiResourceV1alpha3DeviceAllocationConfiguration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
