...
export function V1beta1CustomizeComponentsPatchFromJSON(
  json: any,
): V1beta1CustomizeComponentsPatch {
  return V1beta1CustomizeComponentsPatchFromJSONTyped(json, false);
}

export function V1beta1CustomizeComponentsPatchFromJSONTyped(
  json: any,
...
export function V1beta1CustomizeComponentsPatchToJSON(
  value?: V1beta1CustomizeComponentsPatch | null,
): any {
  if (value === undefined) {
    return undefined;
  }
