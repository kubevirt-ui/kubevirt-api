...
export function IoK8sApiBatchV1beta1CronJobStatusFromJSON(
  json: any,
): IoK8sApiBatchV1beta1CronJobStatus {
  return IoK8sApiBatchV1beta1CronJobStatusFromJSONTyped(json, false);
}

export function IoK8sApiBatchV1beta1CronJobStatusFromJSONTyped(
  json: any,
...
export function IoK8sApiBatchV1beta1CronJobStatusToJSON(
  value?: IoK8sApiBatchV1beta1CronJobStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
