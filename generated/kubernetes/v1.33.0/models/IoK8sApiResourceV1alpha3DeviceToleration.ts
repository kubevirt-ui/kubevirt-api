 ...
 * @export
 * @interface IoK8sApiResourceV1alpha3DeviceToleration
 */
...
export function IoK8sApiResourceV1alpha3DeviceTolerationFromJSON(json: any): IoK8sApiResourceV1alpha3DeviceToleration {
    return IoK8sApiResourceV1alpha3DeviceTolerationFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha3DeviceTolerationFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1alpha3DeviceToleration {
...
export function IoK8sApiResourceV1alpha3DeviceTolerationToJSON(value?: IoK8sApiResourceV1alpha3DeviceToleration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
