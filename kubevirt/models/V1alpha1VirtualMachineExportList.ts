...
export function V1alpha1VirtualMachineExportListFromJSON(
  json: any,
): V1alpha1VirtualMachineExportList {
  return V1alpha1VirtualMachineExportListFromJSONTyped(json, false);
}

export function V1alpha1VirtualMachineExportListFromJSONTyped(
  json: any,
...
export function V1alpha1VirtualMachineExportListToJSON(
  value?: V1alpha1VirtualMachineExportList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
