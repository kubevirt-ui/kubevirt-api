...
export function IoK8sApiResourceV1alpha2NamedResourcesFilterFromJSON(
  json: any,
): IoK8sApiResourceV1alpha2NamedResourcesFilter {
  return IoK8sApiResourceV1alpha2NamedResourcesFilterFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2NamedResourcesFilterFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha2NamedResourcesFilterToJSON(
  value?: IoK8sApiResourceV1alpha2NamedResourcesFilter | null,
): any {
  if (value === undefined) {
    return undefined;
  }
