...
export function IoK8sApiAdmissionregistrationV1beta1VariableFromJSON(
  json: any,
): IoK8sApiAdmissionregistrationV1beta1Variable {
  return IoK8sApiAdmissionregistrationV1beta1VariableFromJSONTyped(json, false);
}

export function IoK8sApiAdmissionregistrationV1beta1VariableFromJSONTyped(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1beta1VariableToJSON(
  value?: IoK8sApiAdmissionregistrationV1beta1Variable | null,
): any {
  if (value === undefined) {
    return undefined;
  }
