...
export function IoK8sApiAdmissionregistrationV1alpha1ParamKindFromJSON(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1alpha1ParamKindFromJSONTyped(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1alpha1ParamKindToJSON(
  value?: IoK8sApiAdmissionregistrationV1alpha1ParamKind | null,
): any {
  if (value === undefined) {
    return undefined;
  }
