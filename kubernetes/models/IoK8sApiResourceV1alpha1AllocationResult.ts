...
export function IoK8sApiResourceV1alpha1AllocationResultFromJSON(
  json: any,
): IoK8sApiResourceV1alpha1AllocationResult {
  return IoK8sApiResourceV1alpha1AllocationResultFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha1AllocationResultFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha1AllocationResultToJSON(
  value?: IoK8sApiResourceV1alpha1AllocationResult | null,
): any {
  if (value === undefined) {
    return undefined;
  }
