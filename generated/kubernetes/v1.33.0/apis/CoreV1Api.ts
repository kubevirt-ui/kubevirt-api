...
export class CoreV1Api extends runtime.BaseAPI {
     ...
     */
    async patchCoreV1NamespacedPodResizeRaw(requestParameters: PatchCoreV1NamespacedPodResizeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<IoK8sApiCoreV1Pod>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling patchCoreV1NamespacedPodResize.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling patchCoreV1NamespacedPodResize.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling patchCoreV1NamespacedPodResize.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/namespaces/{namespace}/pods/{name}/resize`.replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))).replace(`{${"namespace"}}`, encodeURIComponent(String(requestParameters.namespace))),
            method: 'PATCH',
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters.body as any,
     ...
     * partially update resize of the specified Pod
     */
    async patchCoreV1NamespacedPodResize(requestParameters: PatchCoreV1NamespacedPodResizeRequest, initOverrides?: RequestInit): Promise<IoK8sApiCoreV1Pod> {
     ...
     */
    async readCoreV1NamespacedPodResizeRaw(requestParameters: ReadCoreV1NamespacedPodResizeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<IoK8sApiCoreV1Pod>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling readCoreV1NamespacedPodResize.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling readCoreV1NamespacedPodResize.');
        }
     ...
     * read resize of the specified Pod
     */
    async readCoreV1NamespacedPodResize(requestParameters: ReadCoreV1NamespacedPodResizeRequest, initOverrides?: RequestInit): Promise<IoK8sApiCoreV1Pod> {
     ...
     */
    async replaceCoreV1NamespacedPodResizeRaw(requestParameters: ReplaceCoreV1NamespacedPodResizeRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<IoK8sApiCoreV1Pod>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling replaceCoreV1NamespacedPodResize.');
        }

        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling replaceCoreV1NamespacedPodResize.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling replaceCoreV1NamespacedPodResize.');
        }
     ...
     * replace resize of the specified Pod
     */
    async replaceCoreV1NamespacedPodResize(requestParameters: ReplaceCoreV1NamespacedPodResizeRequest, initOverrides?: RequestInit): Promise<IoK8sApiCoreV1Pod> {
        const response = await this.replaceCoreV1NamespacedPodResizeRaw(requestParameters, initOverrides);
        return await response.value();
    }
