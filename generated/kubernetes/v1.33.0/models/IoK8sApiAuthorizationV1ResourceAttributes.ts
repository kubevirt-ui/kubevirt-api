...
export function IoK8sApiAuthorizationV1ResourceAttributesFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAuthorizationV1ResourceAttributes {
    ...
    return {
        ...
        'fieldSelector': !exists(json, 'fieldSelector') ? undefined : IoK8sApiAuthorizationV1FieldSelectorAttributesFromJSON(json['fieldSelector']),
        'group': !exists(json, 'group') ? undefined : json['group'],
        'labelSelector': !exists(json, 'labelSelector') ? undefined : IoK8sApiAuthorizationV1LabelSelectorAttributesFromJSON(json['labelSelector']),
