...
import {
    ...
    IoK8sApiResourceV1alpha1ResourceClaimStatusFromJSONTyped,
...
export function IoK8sApiResourceV1alpha1ResourceClaimFromJSON(json: any): IoK8sApiResourceV1alpha1ResourceClaim {
    return IoK8sApiResourceV1alpha1ResourceClaimFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha1ResourceClaimFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1alpha1ResourceClaim {
    ...
    return {
        ...
        'status': !exists(json, 'status') ? undefined : IoK8sApiResourceV1alpha1ResourceClaimStatusFromJSON(json['status']),
    };
}

export function IoK8sApiResourceV1alpha1ResourceClaimToJSON(value?: IoK8sApiResourceV1alpha1ResourceClaim | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
