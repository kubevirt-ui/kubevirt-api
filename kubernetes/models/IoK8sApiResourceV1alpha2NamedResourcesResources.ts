...
export function IoK8sApiResourceV1alpha2NamedResourcesResourcesFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha2NamedResourcesResourcesFromJSONTyped(
  json: any,
  ...
  return {
    instances: (json['instances'] as Array<any>).map(
      IoK8sApiResourceV1alpha2NamedResourcesInstanceFromJSON,
    ),
  };
}

export function IoK8sApiResourceV1alpha2NamedResourcesResourcesToJSON(
  value?: IoK8sApiResourceV1alpha2NamedResourcesResources | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    instances: (value.instances as Array<any>).map(
      IoK8sApiResourceV1alpha2NamedResourcesInstanceToJSON,
    ),
  };
}
