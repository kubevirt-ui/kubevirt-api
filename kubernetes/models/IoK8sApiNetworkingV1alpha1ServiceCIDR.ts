...
export function IoK8sApiNetworkingV1alpha1ServiceCIDRFromJSON(
  json: any,
): IoK8sApiNetworkingV1alpha1ServiceCIDR {
  return IoK8sApiNetworkingV1alpha1ServiceCIDRFromJSONTyped(json, false);
}

export function IoK8sApiNetworkingV1alpha1ServiceCIDRFromJSONTyped(
  json: any,
  ...
  return {
    ...
    spec: !exists(json, 'spec')
      ? undefined
      : IoK8sApiNetworkingV1alpha1ServiceCIDRSpecFromJSON(json['spec']),
    status: !exists(json, 'status')
      ? undefined
      : IoK8sApiNetworkingV1alpha1ServiceCIDRStatusFromJSON(json['status']),
  };
}

export function IoK8sApiNetworkingV1alpha1ServiceCIDRToJSON(
  value?: IoK8sApiNetworkingV1alpha1ServiceCIDR | null,
): any {
  if (value === undefined) {
    return undefined;
  }
