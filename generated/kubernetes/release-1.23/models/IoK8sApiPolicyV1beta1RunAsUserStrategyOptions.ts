...
export function IoK8sApiPolicyV1beta1RunAsUserStrategyOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiPolicyV1beta1RunAsUserStrategyOptions {
...
export function IoK8sApiPolicyV1beta1RunAsUserStrategyOptionsToJSON(value?: IoK8sApiPolicyV1beta1RunAsUserStrategyOptions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
