...
export function IoK8sApiNodeV1alpha1RuntimeClassSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiNodeV1alpha1RuntimeClassSpec {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'overhead': !exists(json, 'overhead') ? undefined : IoK8sApiNodeV1alpha1OverheadFromJSON(json['overhead']),
        'runtimeHandler': json['runtimeHandler'],
        'scheduling': !exists(json, 'scheduling') ? undefined : IoK8sApiNodeV1alpha1SchedulingFromJSON(json['scheduling']),
    };
}

export function IoK8sApiNodeV1alpha1RuntimeClassSpecToJSON(value?: IoK8sApiNodeV1alpha1RuntimeClassSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
