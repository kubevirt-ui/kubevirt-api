...
export function V1alpha1VirtualMachineSnapshotSpecFromJSON(
  json: any,
): V1alpha1VirtualMachineSnapshotSpec {
  return V1alpha1VirtualMachineSnapshotSpecFromJSONTyped(json, false);
}

export function V1alpha1VirtualMachineSnapshotSpecFromJSONTyped(
  json: any,
...
export function V1alpha1VirtualMachineSnapshotSpecToJSON(
  value?: V1alpha1VirtualMachineSnapshotSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
