...
import { V1beta1NodeNetworkConfigurationEnactmentStatus } from './V1beta1NodeNetworkConfigurationEnactmentStatus';
...
More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   ...
   *
   * @required {false}
   * @originalType {V1beta1NodeNetworkConfigurationEnactmentMetadata}
   */
