...
export function IoK8sApiAutoscalingV2beta1PodsMetricStatusFromJSON(
  json: any,
): IoK8sApiAutoscalingV2beta1PodsMetricStatus {
  return IoK8sApiAutoscalingV2beta1PodsMetricStatusFromJSONTyped(json, false);
}

export function IoK8sApiAutoscalingV2beta1PodsMetricStatusFromJSONTyped(
  json: any,
...
export function IoK8sApiAutoscalingV2beta1PodsMetricStatusToJSON(
  value?: IoK8sApiAutoscalingV2beta1PodsMetricStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
