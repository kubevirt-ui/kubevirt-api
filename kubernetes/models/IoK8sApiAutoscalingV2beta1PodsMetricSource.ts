...
export function IoK8sApiAutoscalingV2beta1PodsMetricSourceFromJSON(
  json: any,
): IoK8sApiAutoscalingV2beta1PodsMetricSource {
  return IoK8sApiAutoscalingV2beta1PodsMetricSourceFromJSONTyped(json, false);
}

export function IoK8sApiAutoscalingV2beta1PodsMetricSourceFromJSONTyped(
  json: any,
...
export function IoK8sApiAutoscalingV2beta1PodsMetricSourceToJSON(
  value?: IoK8sApiAutoscalingV2beta1PodsMetricSource | null,
): any {
  if (value === undefined) {
    return undefined;
  }
