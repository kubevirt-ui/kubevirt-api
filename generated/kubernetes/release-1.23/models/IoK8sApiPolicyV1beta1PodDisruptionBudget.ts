...
import {
    ...
    IoK8sApiPolicyV1beta1PodDisruptionBudgetSpecFromJSONTyped,
    ...
    IoK8sApiPolicyV1beta1PodDisruptionBudgetStatusFromJSONTyped,
...
export function IoK8sApiPolicyV1beta1PodDisruptionBudgetFromJSON(json: any): IoK8sApiPolicyV1beta1PodDisruptionBudget {
    return IoK8sApiPolicyV1beta1PodDisruptionBudgetFromJSONTyped(json, false);
}

export function IoK8sApiPolicyV1beta1PodDisruptionBudgetFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiPolicyV1beta1PodDisruptionBudget {
...
export function IoK8sApiPolicyV1beta1PodDisruptionBudgetToJSON(value?: IoK8sApiPolicyV1beta1PodDisruptionBudget | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
