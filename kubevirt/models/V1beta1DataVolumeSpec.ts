...
export function V1beta1DataVolumeSpecFromJSONTyped(
  json: any,
  ...
  return {
    checkpoints: !exists(json, 'checkpoints')
      ? undefined
      : (json['checkpoints'] as Array<any>).map(V1beta1DataVolumeCheckpointFromJSON),
    ...
    pvc: !exists(json, 'pvc')
      ? undefined
      : K8sIoApiCoreV1PersistentVolumeClaimSpecFromJSON(json['pvc']),
  ...
  return {
    checkpoints:
      value.checkpoints === undefined
        ? undefined
        : (value.checkpoints as Array<any>).map(V1beta1DataVolumeCheckpointToJSON),
