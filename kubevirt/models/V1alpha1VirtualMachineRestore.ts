...
export function V1alpha1VirtualMachineRestoreFromJSONTyped(
  json: any,
  ...
  return {
    ...
    status: !exists(json, 'status')
      ? undefined
      : V1alpha1VirtualMachineRestoreStatusFromJSON(json['status']),
  };
}

export function V1alpha1VirtualMachineRestoreToJSON(
  value?: V1alpha1VirtualMachineRestore | null,
): any {
  if (value === undefined) {
    return undefined;
  }
