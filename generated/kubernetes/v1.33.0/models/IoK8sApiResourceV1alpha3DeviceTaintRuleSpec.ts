...
export function IoK8sApiResourceV1alpha3DeviceTaintRuleSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiResourceV1alpha3DeviceTaintRuleSpec {
    ...
    return {
        ...
        'deviceSelector': !exists(json, 'deviceSelector') ? undefined : IoK8sApiResourceV1alpha3DeviceTaintSelectorFromJSON(json['deviceSelector']),
        'taint': IoK8sApiResourceV1alpha3DeviceTaintFromJSON(json['taint']),
    };
}

export function IoK8sApiResourceV1alpha3DeviceTaintRuleSpecToJSON(value?: IoK8sApiResourceV1alpha3DeviceTaintRuleSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
