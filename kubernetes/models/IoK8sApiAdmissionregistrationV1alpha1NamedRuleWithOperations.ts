...
export function IoK8sApiAdmissionregistrationV1alpha1NamedRuleWithOperationsFromJSON(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1alpha1NamedRuleWithOperationsFromJSONTyped(
  json: any,
...
export function IoK8sApiAdmissionregistrationV1alpha1NamedRuleWithOperationsToJSON(
  value?: IoK8sApiAdmissionregistrationV1alpha1NamedRuleWithOperations | null,
): any {
  if (value === undefined) {
    return undefined;
  }
