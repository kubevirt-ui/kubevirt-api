...
export function IoK8sApiFlowcontrolV1beta3LimitedPriorityLevelConfigurationFromJSON(
  json: any,
...
export function IoK8sApiFlowcontrolV1beta3LimitedPriorityLevelConfigurationFromJSONTyped(
  json: any,
  ...
  return {
    ...
    limitResponse: !exists(json, 'limitResponse')
      ? undefined
      : IoK8sApiFlowcontrolV1beta3LimitResponseFromJSON(json['limitResponse']),
...
export function IoK8sApiFlowcontrolV1beta3LimitedPriorityLevelConfigurationToJSON(
  value?: IoK8sApiFlowcontrolV1beta3LimitedPriorityLevelConfiguration | null,
): any {
  if (value === undefined) {
    return undefined;
  }
