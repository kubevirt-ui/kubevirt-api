...
import type { V1PersistentVolumeClaimSpecAccessModesEnum } from './V1PersistentVolumeClaimSpecAccessModesEnum';
import type { V1PersistentVolumeClaimSpecVolumeModeEnum } from './V1PersistentVolumeClaimSpecVolumeModeEnum';
...
export interface V1PersistentVolumeClaimSpec {
  ...
  accessModes?: V1PersistentVolumeClaimSpecAccessModesEnum[];
