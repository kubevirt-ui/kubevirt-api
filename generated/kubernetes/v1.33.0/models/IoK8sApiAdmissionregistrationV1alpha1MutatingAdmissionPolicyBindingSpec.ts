...
export function IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingSpecFromJSON(json: any): IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingSpec {
    return IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingSpecFromJSONTyped(json, false);
}

export function IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingSpec {
...
export function IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingSpecToJSON(value?: IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
