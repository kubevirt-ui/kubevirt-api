...
export function V1alpha1VirtualMachineSnapshotContentSpecFromJSON(
  json: any,
): V1alpha1VirtualMachineSnapshotContentSpec {
  return V1alpha1VirtualMachineSnapshotContentSpecFromJSONTyped(json, false);
}

export function V1alpha1VirtualMachineSnapshotContentSpecFromJSONTyped(
  json: any,
  ...
  return {
    ...
    volumeBackups: !exists(json, 'volumeBackups')
      ? undefined
      : (json['volumeBackups'] as Array<any>).map(V1alpha1VolumeBackupFromJSON),
  };
}

export function V1alpha1VirtualMachineSnapshotContentSpecToJSON(
  value?: V1alpha1VirtualMachineSnapshotContentSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    volumeBackups:
      value.volumeBackups === undefined
        ? undefined
        : (value.volumeBackups as Array<any>).map(V1alpha1VolumeBackupToJSON),
  };
}
