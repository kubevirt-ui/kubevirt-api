 ...
 * @export
 * @interface V1beta1NodeNetworkConfigurationPolicy
 */
export interface V1beta1NodeNetworkConfigurationPolicy {
    /**
 ...
 */
export function instanceOfV1beta1NodeNetworkConfigurationPolicy(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function V1beta1NodeNetworkConfigurationPolicyFromJSON(json: any): V1beta1NodeNetworkConfigurationPolicy {
    return V1beta1NodeNetworkConfigurationPolicyFromJSONTyped(json, false);
}

export function V1beta1NodeNetworkConfigurationPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1beta1NodeNetworkConfigurationPolicy {
...
export function V1beta1NodeNetworkConfigurationPolicyToJSON(value?: V1beta1NodeNetworkConfigurationPolicy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
