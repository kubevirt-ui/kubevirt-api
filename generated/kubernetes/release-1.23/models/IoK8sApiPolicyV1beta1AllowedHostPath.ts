...
export function IoK8sApiPolicyV1beta1AllowedHostPathFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiPolicyV1beta1AllowedHostPath {
...
export function IoK8sApiPolicyV1beta1AllowedHostPathToJSON(value?: IoK8sApiPolicyV1beta1AllowedHostPath | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
