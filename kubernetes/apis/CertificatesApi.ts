...
export class CertificatesApi extends runtime.BaseAPI {
     ...
     */
    async getCertificatesAPIGroupRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIGroup>> {
     ...
     * get information of a group
     */
    async getCertificatesAPIGroup(initOverrides?: RequestInit): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
