...
export function IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicyStatusFromJSON(
  json: any,
): IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicyStatus {
  return IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicyStatusFromJSONTyped(
    json,
    false,
  );
}

export function IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicyStatusFromJSONTyped(
  json: any,
  ...
  return {
    ...
    typeChecking: !exists(json, 'typeChecking')
      ? undefined
      : IoK8sApiAdmissionregistrationV1alpha1TypeCheckingFromJSON(json['typeChecking']),
  };
}

export function IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicyStatusToJSON(
  value?: IoK8sApiAdmissionregistrationV1alpha1ValidatingAdmissionPolicyStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
