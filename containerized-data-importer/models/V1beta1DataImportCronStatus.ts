...
export function V1beta1DataImportCronStatusFromJSONTyped(json: any, _ignoreDiscriminator: boolean): V1beta1DataImportCronStatus {
    ...
    return {
        ...
        'lastExecutionTimestamp': !exists(json, 'lastExecutionTimestamp') ? undefined : ((json['lastExecutionTimestamp'])),
        'lastImportTimestamp': !exists(json, 'lastImportTimestamp') ? undefined : ((json['lastImportTimestamp'])),
...
export function V1beta1DataImportCronStatusToJSON(value?: V1beta1DataImportCronStatus | null): any {
    ...
    return {
        ...
        'lastExecutionTimestamp': value.lastExecutionTimestamp === undefined ? undefined : (value.lastExecutionTimestamp),
        'lastImportTimestamp': value.lastImportTimestamp === undefined ? undefined : (value.lastImportTimestamp),
