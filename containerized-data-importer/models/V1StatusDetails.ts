...
import { V1StatusCause, V1StatusCauseFromJSON, V1StatusCauseToJSON } from './';
...
export function V1StatusDetailsFromJSONTyped(
  json: any,
  ...
  return {
    causes: !exists(json, 'causes')
      ? undefined
      : (json['causes'] as Array<any>).map(V1StatusCauseFromJSON),
  ...
  return {
    causes:
      value.causes === undefined
        ? undefined
        : (value.causes as Array<any>).map(V1StatusCauseToJSON),
    group: value.group,
    kind: value.kind,
    name: value.name,
