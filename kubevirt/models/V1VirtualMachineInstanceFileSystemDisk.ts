...
export function V1VirtualMachineInstanceFileSystemDiskFromJSON(
  json: any,
): V1VirtualMachineInstanceFileSystemDisk {
  return V1VirtualMachineInstanceFileSystemDiskFromJSONTyped(json, false);
}

export function V1VirtualMachineInstanceFileSystemDiskFromJSONTyped(
  json: any,
...
export function V1VirtualMachineInstanceFileSystemDiskToJSON(
  value?: V1VirtualMachineInstanceFileSystemDisk | null,
): any {
  if (value === undefined) {
    return undefined;
  }
