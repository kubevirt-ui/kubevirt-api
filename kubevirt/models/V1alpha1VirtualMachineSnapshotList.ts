...
export function V1alpha1VirtualMachineSnapshotListFromJSON(
  json: any,
): V1alpha1VirtualMachineSnapshotList {
  return V1alpha1VirtualMachineSnapshotListFromJSONTyped(json, false);
}

export function V1alpha1VirtualMachineSnapshotListFromJSONTyped(
  json: any,
...
export function V1alpha1VirtualMachineSnapshotListToJSON(
  value?: V1alpha1VirtualMachineSnapshotList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
