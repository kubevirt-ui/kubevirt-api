...
export const NetworkAttachmentDefinitionModelGroupVersionKind =
  modelToGroupVersionKind(NetworkAttachmentDefinitionModel);
export const NetworkAttachmentDefinitionModelRef = modelToRef(
