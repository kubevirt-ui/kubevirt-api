...
export const SriovNetworkNodePolicyModelGroupVersionKind =
  modelToGroupVersionKind(SriovNetworkNodePolicyModel);
export const SriovNetworkNodePolicyModelRef = modelToRef(
