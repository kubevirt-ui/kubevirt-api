...
export function IoK8sApiResourceV1alpha2ResourceClaimStatusFromJSON(
  json: any,
): IoK8sApiResourceV1alpha2ResourceClaimStatus {
  return IoK8sApiResourceV1alpha2ResourceClaimStatusFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2ResourceClaimStatusFromJSONTyped(
  json: any,
  ...
  return {
    allocation: !exists(json, 'allocation')
      ? undefined
      : IoK8sApiResourceV1alpha2AllocationResultFromJSON(json['allocation']),
...
export function IoK8sApiResourceV1alpha2ResourceClaimStatusToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClaimStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
