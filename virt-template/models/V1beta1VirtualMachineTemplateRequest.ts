...
import { V1beta1VirtualMachineTemplateRequestSpec } from './V1beta1VirtualMachineTemplateRequestSpec';
import { V1beta1VirtualMachineTemplateRequestStatus } from './V1beta1VirtualMachineTemplateRequestStatus';
 ...
 * @export
 */
export interface V1beta1VirtualMachineTemplateRequest {
  /** apiVersion
