...
export function IoK8sApiAuthenticationV1BoundObjectReferenceFromJSON(
  json: any,
): IoK8sApiAuthenticationV1BoundObjectReference {
  return IoK8sApiAuthenticationV1BoundObjectReferenceFromJSONTyped(json, false);
}

export function IoK8sApiAuthenticationV1BoundObjectReferenceFromJSONTyped(
  json: any,
...
export function IoK8sApiAuthenticationV1BoundObjectReferenceToJSON(
  value?: IoK8sApiAuthenticationV1BoundObjectReference | null,
): any {
  if (value === undefined) {
    return undefined;
  }
