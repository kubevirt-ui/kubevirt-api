 ...
 * @export
 * @interface IoK8sApiNodeV1alpha1Scheduling
 */
export interface IoK8sApiNodeV1alpha1Scheduling {
    /**
     * nodeSelector lists labels that must be present on nodes that support this RuntimeClass. Pods using this RuntimeClass can only be scheduled to a node matched by this selector. The RuntimeClass nodeSelector is merged with a pod's existing nodeSelector. Any conflicts will cause the pod to be rejected in admission.
     * @type {{ [key: string]: string; }}
     * @memberof IoK8sApiNodeV1alpha1Scheduling
     */
...
export function IoK8sApiNodeV1alpha1SchedulingFromJSON(json: any): IoK8sApiNodeV1alpha1Scheduling {
    return IoK8sApiNodeV1alpha1SchedulingFromJSONTyped(json, false);
}

export function IoK8sApiNodeV1alpha1SchedulingFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiNodeV1alpha1Scheduling {
...
export function IoK8sApiNodeV1alpha1SchedulingToJSON(value?: IoK8sApiNodeV1alpha1Scheduling | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
