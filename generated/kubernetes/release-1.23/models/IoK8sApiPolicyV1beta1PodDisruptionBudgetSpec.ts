...
export function IoK8sApiPolicyV1beta1PodDisruptionBudgetSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiPolicyV1beta1PodDisruptionBudgetSpec {
...
export function IoK8sApiPolicyV1beta1PodDisruptionBudgetSpecToJSON(value?: IoK8sApiPolicyV1beta1PodDisruptionBudgetSpec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
