...
export function IoK8sApiNodeV1alpha1RuntimeClassListFromJSON(
  json: any,
): IoK8sApiNodeV1alpha1RuntimeClassList {
  return IoK8sApiNodeV1alpha1RuntimeClassListFromJSONTyped(json, false);
}

export function IoK8sApiNodeV1alpha1RuntimeClassListFromJSONTyped(
  json: any,
...
export function IoK8sApiNodeV1alpha1RuntimeClassListToJSON(
  value?: IoK8sApiNodeV1alpha1RuntimeClassList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
