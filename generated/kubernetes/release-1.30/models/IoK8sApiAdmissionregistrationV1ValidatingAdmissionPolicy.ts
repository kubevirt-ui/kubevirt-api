...
export function IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicy {
    ...
    return {
        ...
        'spec': !exists(json, 'spec') ? undefined : IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicySpecFromJSON(json['spec']),
        'status': !exists(json, 'status') ? undefined : IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyStatusFromJSON(json['status']),
    };
}

export function IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyToJSON(value?: IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
