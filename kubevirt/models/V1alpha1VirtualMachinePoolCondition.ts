...
export function V1alpha1VirtualMachinePoolConditionFromJSON(
  json: any,
): V1alpha1VirtualMachinePoolCondition {
  return V1alpha1VirtualMachinePoolConditionFromJSONTyped(json, false);
}

export function V1alpha1VirtualMachinePoolConditionFromJSONTyped(
  json: any,
...
export function V1alpha1VirtualMachinePoolConditionToJSON(
  value?: V1alpha1VirtualMachinePoolCondition | null,
): any {
  if (value === undefined) {
    return undefined;
  }
