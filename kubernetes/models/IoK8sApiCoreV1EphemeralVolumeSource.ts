...
export function IoK8sApiCoreV1EphemeralVolumeSourceFromJSON(
  json: any,
): IoK8sApiCoreV1EphemeralVolumeSource {
  return IoK8sApiCoreV1EphemeralVolumeSourceFromJSONTyped(json, false);
}

export function IoK8sApiCoreV1EphemeralVolumeSourceFromJSONTyped(
  json: any,
  ...
  return {
    volumeClaimTemplate: !exists(json, 'volumeClaimTemplate')
      ? undefined
      : IoK8sApiCoreV1PersistentVolumeClaimTemplateFromJSON(json['volumeClaimTemplate']),
  };
}

export function IoK8sApiCoreV1EphemeralVolumeSourceToJSON(
  value?: IoK8sApiCoreV1EphemeralVolumeSource | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    volumeClaimTemplate: IoK8sApiCoreV1PersistentVolumeClaimTemplateToJSON(
