...
export function IoK8sApiDiscoveryV1beta1EndpointPortFromJSON(
  json: any,
): IoK8sApiDiscoveryV1beta1EndpointPort {
  return IoK8sApiDiscoveryV1beta1EndpointPortFromJSONTyped(json, false);
}

export function IoK8sApiDiscoveryV1beta1EndpointPortFromJSONTyped(
  json: any,
...
export function IoK8sApiDiscoveryV1beta1EndpointPortToJSON(
  value?: IoK8sApiDiscoveryV1beta1EndpointPort | null,
): any {
  if (value === undefined) {
    return undefined;
  }
