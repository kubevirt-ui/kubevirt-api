...
export class NodeV1Api extends runtime.BaseAPI {
   ...
   */
  async createNodeV1RuntimeClassRaw(
    requestParameters: CreateNodeV1RuntimeClassRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApiNodeV1RuntimeClass>> {
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new runtime.RequiredError(
        'body',
        'Required parameter requestParameters.body was null or undefined when calling createNodeV1RuntimeClass.',
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      IoK8sApiNodeV1RuntimeClassFromJSON(jsonValue),
    );
  }
   ...
   */
  async deleteNodeV1CollectionRuntimeClassRaw(
    requestParameters: DeleteNodeV1CollectionRuntimeClassRequest,
    initOverrides?: RequestInit,
  ...
  async deleteNodeV1CollectionRuntimeClass(
    ...
    const response = await this.deleteNodeV1CollectionRuntimeClassRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async deleteNodeV1RuntimeClassRaw(
    requestParameters: DeleteNodeV1RuntimeClassRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1Status>> {
    if (requestParameters.name === null || requestParameters.name === undefined) {
      throw new runtime.RequiredError(
        'name',
        'Required parameter requestParameters.name was null or undefined when calling deleteNodeV1RuntimeClass.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/apis/node.k8s.io/v1/runtimeclasses/{name}`.replace(
          `{${'name'}}`,
   ...
   */
  async getNodeV1APIResourcesRaw(
    initOverrides?: RequestInit,
   ...
   */
  async listNodeV1RuntimeClassRaw(
    requestParameters: ListNodeV1RuntimeClassRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApiNodeV1RuntimeClassList>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      IoK8sApiNodeV1RuntimeClassListFromJSON(jsonValue),
    );
  }
   ...
   */
  async patchNodeV1RuntimeClassRaw(
    requestParameters: PatchNodeV1RuntimeClassRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApiNodeV1RuntimeClass>> {
    if (requestParameters.name === null || requestParameters.name === undefined) {
      throw new runtime.RequiredError(
        'name',
        'Required parameter requestParameters.name was null or undefined when calling patchNodeV1RuntimeClass.',
      );
    }
    ...
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new runtime.RequiredError(
        'body',
        'Required parameter requestParameters.body was null or undefined when calling patchNodeV1RuntimeClass.',
      );
    }
   ...
   */
  async readNodeV1RuntimeClassRaw(
    requestParameters: ReadNodeV1RuntimeClassRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApiNodeV1RuntimeClass>> {
    if (requestParameters.name === null || requestParameters.name === undefined) {
      throw new runtime.RequiredError(
        'name',
        'Required parameter requestParameters.name was null or undefined when calling readNodeV1RuntimeClass.',
      );
    }
   ...
   */
  async replaceNodeV1RuntimeClassRaw(
    requestParameters: ReplaceNodeV1RuntimeClassRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApiNodeV1RuntimeClass>> {
    if (requestParameters.name === null || requestParameters.name === undefined) {
      throw new runtime.RequiredError(
        'name',
        'Required parameter requestParameters.name was null or undefined when calling replaceNodeV1RuntimeClass.',
      );
    }
    ...
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new runtime.RequiredError(
        'body',
        'Required parameter requestParameters.body was null or undefined when calling replaceNodeV1RuntimeClass.',
      );
    }
   ...
   */
  async watchNodeV1RuntimeClassRaw(
    requestParameters: WatchNodeV1RuntimeClassRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1WatchEvent>> {
    if (requestParameters.name === null || requestParameters.name === undefined) {
      throw new runtime.RequiredError(
        'name',
        'Required parameter requestParameters.name was null or undefined when calling watchNodeV1RuntimeClass.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/apis/node.k8s.io/v1/watch/runtimeclasses/{name}`.replace(
          `{${'name'}}`,
          encodeURIComponent(String(requestParameters.name)),
        ),
        method: 'GET',
   ...
   */
  async watchNodeV1RuntimeClassListRaw(
    requestParameters: WatchNodeV1RuntimeClassListRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1WatchEvent>> {
    const queryParameters: any = {};
