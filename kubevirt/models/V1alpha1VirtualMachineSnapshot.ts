...
export function V1alpha1VirtualMachineSnapshotFromJSONTyped(
  json: any,
  ...
  return {
    ...
    status: !exists(json, 'status')
      ? undefined
      : V1alpha1VirtualMachineSnapshotStatusFromJSON(json['status']),
  };
}

export function V1alpha1VirtualMachineSnapshotToJSON(
  value?: V1alpha1VirtualMachineSnapshot | null,
): any {
  if (value === undefined) {
    return undefined;
  }
