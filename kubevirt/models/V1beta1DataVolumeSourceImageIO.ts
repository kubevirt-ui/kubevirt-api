...
export function V1beta1DataVolumeSourceImageIOFromJSONTyped(
  json: any,
...
export function V1beta1DataVolumeSourceImageIOToJSON(
  value?: V1beta1DataVolumeSourceImageIO | null,
): any {
  if (value === undefined) {
    return undefined;
  }
