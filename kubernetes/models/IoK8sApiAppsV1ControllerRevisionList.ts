...
export function IoK8sApiAppsV1ControllerRevisionListFromJSON(
  json: any,
): IoK8sApiAppsV1ControllerRevisionList {
  return IoK8sApiAppsV1ControllerRevisionListFromJSONTyped(json, false);
}

export function IoK8sApiAppsV1ControllerRevisionListFromJSONTyped(
  json: any,
...
export function IoK8sApiAppsV1ControllerRevisionListToJSON(
  value?: IoK8sApiAppsV1ControllerRevisionList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
