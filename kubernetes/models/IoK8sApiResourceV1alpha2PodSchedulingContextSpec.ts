...
export function IoK8sApiResourceV1alpha2PodSchedulingContextSpecFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha2PodSchedulingContextSpecFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha2PodSchedulingContextSpecToJSON(
  value?: IoK8sApiResourceV1alpha2PodSchedulingContextSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
