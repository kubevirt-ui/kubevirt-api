...
import { V1beta1NMStateSpec } from './V1beta1NMStateSpec';
import { V1beta1NMStateStatus } from './V1beta1NMStateStatus';
...
More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   ...
   *
   * @required {false}
   * @originalType {V1beta1NMStateMetadata}
   */
