...
import { V1beta1VirtualMachineTemplateSpec } from './V1beta1VirtualMachineTemplateSpec';
import { V1beta1VirtualMachineTemplateStatus } from './V1beta1VirtualMachineTemplateStatus';
 ...
 * @export
 */
export interface V1beta1VirtualMachineTemplate {
  /** apiVersion
