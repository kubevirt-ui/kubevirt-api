...
import {
    ...
    IoK8sApiEventsV1beta1EventSeriesFromJSONTyped,
...
export function IoK8sApiEventsV1beta1EventFromJSON(json: any): IoK8sApiEventsV1beta1Event {
    return IoK8sApiEventsV1beta1EventFromJSONTyped(json, false);
}

export function IoK8sApiEventsV1beta1EventFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiEventsV1beta1Event {
...
export function IoK8sApiEventsV1beta1EventToJSON(value?: IoK8sApiEventsV1beta1Event | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
