...
export function IoK8sApiFlowcontrolV1beta2FlowSchemaStatusFromJSON(
  json: any,
): IoK8sApiFlowcontrolV1beta2FlowSchemaStatus {
  return IoK8sApiFlowcontrolV1beta2FlowSchemaStatusFromJSONTyped(json, false);
}

export function IoK8sApiFlowcontrolV1beta2FlowSchemaStatusFromJSONTyped(
  json: any,
...
export function IoK8sApiFlowcontrolV1beta2FlowSchemaStatusToJSON(
  value?: IoK8sApiFlowcontrolV1beta2FlowSchemaStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    conditions:
      value.conditions === undefined
        ? undefined
        : (value.conditions as Array<any>).map(IoK8sApiFlowcontrolV1beta2FlowSchemaConditionToJSON),
  };
}
