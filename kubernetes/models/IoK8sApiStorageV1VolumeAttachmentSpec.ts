...
export function IoK8sApiStorageV1VolumeAttachmentSpecFromJSON(
  json: any,
): IoK8sApiStorageV1VolumeAttachmentSpec {
  return IoK8sApiStorageV1VolumeAttachmentSpecFromJSONTyped(json, false);
}

export function IoK8sApiStorageV1VolumeAttachmentSpecFromJSONTyped(
  json: any,
...
export function IoK8sApiStorageV1VolumeAttachmentSpecToJSON(
  value?: IoK8sApiStorageV1VolumeAttachmentSpec | null,
): any {
  if (value === undefined) {
    return undefined;
  }
