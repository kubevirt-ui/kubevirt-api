...
import type { V1PersistentVolumeClaimInfoAccessModesEnum } from './V1PersistentVolumeClaimInfoAccessModesEnum';
import type { V1PersistentVolumeClaimInfoVolumeModeEnum } from './V1PersistentVolumeClaimInfoVolumeModeEnum';
