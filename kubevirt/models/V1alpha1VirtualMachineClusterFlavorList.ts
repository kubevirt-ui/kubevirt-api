...
export function V1alpha1VirtualMachineClusterFlavorListFromJSON(
  json: any,
): V1alpha1VirtualMachineClusterFlavorList {
  return V1alpha1VirtualMachineClusterFlavorListFromJSONTyped(json, false);
}

export function V1alpha1VirtualMachineClusterFlavorListFromJSONTyped(
  json: any,
...
export function V1alpha1VirtualMachineClusterFlavorListToJSON(
  value?: V1alpha1VirtualMachineClusterFlavorList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
