...
export interface IoK8sApiAdmissionregistrationV1ParamRef {
     ...
     * @type {string}
     * @memberof IoK8sApiAdmissionregistrationV1ParamRef
     */
    name?: string;
    /**
...
export function IoK8sApiAdmissionregistrationV1ParamRefFromJSON(json: any): IoK8sApiAdmissionregistrationV1ParamRef {
    return IoK8sApiAdmissionregistrationV1ParamRefFromJSONTyped(json, false);
}

export function IoK8sApiAdmissionregistrationV1ParamRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAdmissionregistrationV1ParamRef {
...
export function IoK8sApiAdmissionregistrationV1ParamRefToJSON(value?: IoK8sApiAdmissionregistrationV1ParamRef | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
