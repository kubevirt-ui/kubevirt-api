 ...
 * @export
 * @interface V1alpha2FeaturePreferences
 */
export interface V1alpha2FeaturePreferences {
    /**
     * 
     * @type {V1FeatureState}
     * @memberof V1alpha2FeaturePreferences
     */
...
export function V1alpha2FeaturePreferencesFromJSON(json: any): V1alpha2FeaturePreferences {
    return V1alpha2FeaturePreferencesFromJSONTyped(json, false);
}

export function V1alpha2FeaturePreferencesFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1alpha2FeaturePreferences {
...
export function V1alpha2FeaturePreferencesToJSON(value?: V1alpha2FeaturePreferences | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
