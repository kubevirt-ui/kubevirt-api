...
export function IoK8sApiPolicyV1beta1SELinuxStrategyOptionsFromJSON(
  json: any,
): IoK8sApiPolicyV1beta1SELinuxStrategyOptions {
  return IoK8sApiPolicyV1beta1SELinuxStrategyOptionsFromJSONTyped(json, false);
}

export function IoK8sApiPolicyV1beta1SELinuxStrategyOptionsFromJSONTyped(
  json: any,
...
export function IoK8sApiPolicyV1beta1SELinuxStrategyOptionsToJSON(
  value?: IoK8sApiPolicyV1beta1SELinuxStrategyOptions | null,
): any {
  if (value === undefined) {
    return undefined;
  }
