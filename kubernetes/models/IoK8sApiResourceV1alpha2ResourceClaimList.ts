...
export function IoK8sApiResourceV1alpha2ResourceClaimListFromJSON(
  json: any,
): IoK8sApiResourceV1alpha2ResourceClaimList {
  return IoK8sApiResourceV1alpha2ResourceClaimListFromJSONTyped(json, false);
}

export function IoK8sApiResourceV1alpha2ResourceClaimListFromJSONTyped(
  json: any,
...
export function IoK8sApiResourceV1alpha2ResourceClaimListToJSON(
  value?: IoK8sApiResourceV1alpha2ResourceClaimList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
