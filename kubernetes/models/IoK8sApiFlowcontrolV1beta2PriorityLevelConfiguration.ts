...
export function IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationFromJSON(
  json: any,
...
export function IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationFromJSONTyped(
  json: any,
  ...
  return {
    ...
    spec: !exists(json, 'spec')
      ? undefined
      : IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationSpecFromJSON(json['spec']),
    status: !exists(json, 'status')
      ? undefined
      : IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationStatusFromJSON(json['status']),
  };
}

export function IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationToJSON(
  value?: IoK8sApiFlowcontrolV1beta2PriorityLevelConfiguration | null,
): any {
  if (value === undefined) {
    return undefined;
  }
