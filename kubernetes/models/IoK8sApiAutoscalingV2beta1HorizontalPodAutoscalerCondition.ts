...
export function IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerConditionFromJSON(
  json: any,
...
export function IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerConditionFromJSONTyped(
  json: any,
...
export function IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerConditionToJSON(
  value?: IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerCondition | null,
): any {
  if (value === undefined) {
    return undefined;
  }
