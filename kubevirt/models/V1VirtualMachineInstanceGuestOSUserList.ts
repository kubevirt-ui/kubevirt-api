...
export function V1VirtualMachineInstanceGuestOSUserListFromJSON(
  json: any,
): V1VirtualMachineInstanceGuestOSUserList {
  return V1VirtualMachineInstanceGuestOSUserListFromJSONTyped(json, false);
}

export function V1VirtualMachineInstanceGuestOSUserListFromJSONTyped(
  json: any,
...
export function V1VirtualMachineInstanceGuestOSUserListToJSON(
  value?: V1VirtualMachineInstanceGuestOSUserList | null,
): any {
  if (value === undefined) {
    return undefined;
  }
