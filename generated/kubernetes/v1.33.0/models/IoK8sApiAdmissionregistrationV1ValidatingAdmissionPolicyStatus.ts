...
export function IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyStatus {
    ...
    return {
        ...
        'typeChecking': !exists(json, 'typeChecking') ? undefined : IoK8sApiAdmissionregistrationV1TypeCheckingFromJSON(json['typeChecking']),
    };
}

export function IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyStatusToJSON(value?: IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
