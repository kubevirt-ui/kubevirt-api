...
export function IoK8sApiCoreV1NodeSelectorTermFromJSONTyped(
  json: any,
  ...
  return {
    matchExpressions: !exists(json, 'matchExpressions')
      ? undefined
      : (json['matchExpressions'] as Array<any>).map(IoK8sApiCoreV1NodeSelectorRequirementFromJSON),
    matchFields: !exists(json, 'matchFields')
      ? undefined
      : (json['matchFields'] as Array<any>).map(IoK8sApiCoreV1NodeSelectorRequirementFromJSON),
  };
}

export function IoK8sApiCoreV1NodeSelectorTermToJSON(
  value?: IoK8sApiCoreV1NodeSelectorTerm | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    matchExpressions:
      value.matchExpressions === undefined
        ? undefined
        : (value.matchExpressions as Array<any>).map(IoK8sApiCoreV1NodeSelectorRequirementToJSON),
    matchFields:
      value.matchFields === undefined
        ? undefined
        : (value.matchFields as Array<any>).map(IoK8sApiCoreV1NodeSelectorRequirementToJSON),
  };
}
