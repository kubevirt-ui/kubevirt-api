...
export function IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingListFromJSONTyped(json: any, ignoreDiscriminator: boolean): IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingList {
    ...
    return {
        ...
        'items': ((json['items'] as Array<any>).map(IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingFromJSON)),
...
export function IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingListToJSON(value?: IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingList | null): any {
    ...
    return {
        ...
        'items': ((value.items as Array<any>).map(IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingToJSON)),
        'kind': value.kind,
