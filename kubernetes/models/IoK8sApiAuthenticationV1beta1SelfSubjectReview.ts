...
export function IoK8sApiAuthenticationV1beta1SelfSubjectReviewFromJSON(
  json: any,
...
export function IoK8sApiAuthenticationV1beta1SelfSubjectReviewFromJSONTyped(
  json: any,
  ...
  return {
    ...
    status: !exists(json, 'status')
      ? undefined
      : IoK8sApiAuthenticationV1beta1SelfSubjectReviewStatusFromJSON(json['status']),
  };
}

export function IoK8sApiAuthenticationV1beta1SelfSubjectReviewToJSON(
  value?: IoK8sApiAuthenticationV1beta1SelfSubjectReview | null,
): any {
  if (value === undefined) {
    return undefined;
  }
