...
export function IoK8sApiPolicyV1beta1PodDisruptionBudgetFromJSON(
  json: any,
): IoK8sApiPolicyV1beta1PodDisruptionBudget {
  return IoK8sApiPolicyV1beta1PodDisruptionBudgetFromJSONTyped(json, false);
}

export function IoK8sApiPolicyV1beta1PodDisruptionBudgetFromJSONTyped(
  json: any,
  ...
  return {
    ...
    spec: !exists(json, 'spec')
      ? undefined
      : IoK8sApiPolicyV1beta1PodDisruptionBudgetSpecFromJSON(json['spec']),
    status: !exists(json, 'status')
      ? undefined
      : IoK8sApiPolicyV1beta1PodDisruptionBudgetStatusFromJSON(json['status']),
  };
}

export function IoK8sApiPolicyV1beta1PodDisruptionBudgetToJSON(
  value?: IoK8sApiPolicyV1beta1PodDisruptionBudget | null,
): any {
  if (value === undefined) {
    return undefined;
  }
