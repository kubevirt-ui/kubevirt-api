...
export function IoK8sApiResourceV1alpha3AllocatedDeviceStatusFromJSON(
  json: any,
...
export function IoK8sApiResourceV1alpha3AllocatedDeviceStatusFromJSONTyped(
  json: any,
  ...
  return {
    ...
    networkData: !exists(json, 'networkData')
      ? undefined
      : IoK8sApiResourceV1alpha3NetworkDeviceDataFromJSON(json['networkData']),
    pool: json['pool'],
  };
}

export function IoK8sApiResourceV1alpha3AllocatedDeviceStatusToJSON(
  value?: IoK8sApiResourceV1alpha3AllocatedDeviceStatus | null,
): any {
  if (value === undefined) {
    return undefined;
  }
